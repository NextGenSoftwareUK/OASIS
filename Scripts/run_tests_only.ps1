...
# Save full output to Test Results directory
$testResultsDir = Join-Path (Split-Path -Parent (Split-Path -Parent $PSScriptRoot)) "STAR ODK\NextGenSoftware.OASIS.STAR.WebAPI\Test Results"
