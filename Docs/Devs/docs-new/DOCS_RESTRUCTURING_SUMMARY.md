...
### 6. Holons (concept-first)

- ✅ **What are Holons?** (`concepts/holons.md`) - Core concept, identity-first, where holons sit in the stack
- ✅ **How to use holons** (`guides/using-holons.md`) - Quick start, load/save/children, code examples (TS, cURL)
- ✅ **Holons API** (`web4-oasis-api/data-storage/holons-api.md`) - Data API holon endpoints reference (`/api/data`)
...
**Key Files:**
- `index.md` - Homepage
- `concepts/holons.md` - What are Holons? (start here for the data model)
- `guides/using-holons.md` - How to use holons (quick start + patterns)
- `web4-oasis-api/data-storage/holons-api.md` - Data API holon operations reference
...
2. `SUMMARY.md` - GitBook table of contents (see also this file)
...
- **Publish to GitBook:** [guides/PUBLISH_TO_GITBOOK.md](guides/PUBLISH_TO_GITBOOK.md)
