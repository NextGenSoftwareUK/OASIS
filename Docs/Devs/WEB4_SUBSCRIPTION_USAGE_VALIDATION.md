...
The next required inputs are the protected configuration locations for staging/provider/Stripe access. This new installation does not require retained historical billing evidence. Keep credentials out of chat, PRs, manifests and result artifacts.
