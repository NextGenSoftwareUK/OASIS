...
|---|---|---|
| **[NextGenSoftwareUK/OASIS](https://github.com/NextGenSoftwareUK/OASIS)** | Main monorepo — WEB4 OASIS API, 142 storage/blockchain/social/network providers, WebAPI, Swagger, Docker, Railway deploy configs | Public face of the platform; community entry point |
