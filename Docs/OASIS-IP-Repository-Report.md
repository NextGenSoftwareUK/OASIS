...
|---|---|---|
| **[NextGenSoftwareUK/OASIS](https://github.com/NextGenSoftwareUK/OASIS)** | Main monorepo — WEB4 OASIS API, 184 storage/blockchain/social/network providers, WebAPI, Swagger, Docker, Railway deploy configs | Public face of the platform; community entry point |
...
| **[NextGenSoftwareUK/OASIS-WEB6](https://github.com/NextGenSoftwareUK/OASIS-WEB6)** | WEB6 AI layer — FAHRN multi-agent orchestration (5 dispatch modes, ML.NET classifier), Holonic BRAID shared reasoning graph, SkillOpt self-evolving skills, 259 MCP tools, 56 REST endpoints, DID/VC identity, 99 AI model providers (OpenAI, Anthropic, Gemini, Groq, Mistral, DeepSeek, xAI, Cohere, Ollama, Azure OpenAI, AWS Bedrock + more), 6 orchestrator adapters (MCP, A2A, LangChain, AutoGen, CrewAI, Semantic Kernel) | Next-generation AI platform IP; primary revenue growth engine |
