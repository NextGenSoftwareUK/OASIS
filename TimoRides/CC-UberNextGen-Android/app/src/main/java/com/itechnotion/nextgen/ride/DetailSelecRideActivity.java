...
import com.itechnotion.nextgen.payment.PaymentActivity;
...
public class DetailSelecRideActivity extends AppCompatActivity implements OnMapReadyCallback, LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, GoogleMap.OnPolylineClickListener, GoogleMap.OnPolygonClickListener {
    ...
    @BindView(R.id.tvBookingReq)
    TextView tvBookingReq;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_selec_ride);
    ...
    @OnClick({R.id.ivBack, R.id.llPayment, R.id.llPromo, R.id.llCancel, R.id.tvBookingReq})
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.ivBack:
                ...
                break;
            case R.id.llPayment:
                intent=new Intent(DetailSelecRideActivity.this, PaymentActivity.class);
                startActivity(intent);
                break;
            case R.id.llPromo:
                 intent=new Intent(DetailSelecRideActivity.this,PromoActivity.class);
                startActivity(intent);
                break;
            case R.id.llCancel:
                intent=new Intent(DetailSelecRideActivity.this,BookingCancelActivity.class);
                startActivity(intent);
                break;
            case R.id.tvBookingReq:
                 intent=new Intent(DetailSelecRideActivity.this,BookingRequestActivity.class);
                startActivity(intent);
                break;
        }
    }
