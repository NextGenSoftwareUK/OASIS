...
// import io.github.inflationx.viewpump.ViewPumpContextWrapper; // Commented out - library removed
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void attachBaseContext(Context newBase) {
        super.attachBaseContext(newBase); // Removed ViewPumpContextWrapper - library removed
    }
