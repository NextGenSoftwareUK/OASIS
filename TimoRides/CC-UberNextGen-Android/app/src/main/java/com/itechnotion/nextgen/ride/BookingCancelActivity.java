...
public class BookingCancelActivity extends AppCompatActivity implements OnMapReadyCallback, LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, GoogleMap.OnPolylineClickListener, GoogleMap.OnPolygonClickListener {
    ...
    @OnClick({R.id.cvMenu, R.id.tvBookingReq,R.id.ivChat,R.id.ivCall})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.cvMenu:
                ...
                break;
            case R.id.ivChat:
                Intent intent1 = new Intent(BookingCancelActivity.this, ChatActivity.class);
            ...
            case R.id.tvBookingReq:
                Intent intent = new Intent(BookingCancelActivity.this, HomepageActivity.class);
