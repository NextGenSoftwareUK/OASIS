...
import com.itechnotion.nextgen.chat.ChatActivity;
...
public class BookingRequestActivity extends AppCompatActivity implements OnMapReadyCallback, LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, GoogleMap.OnPolylineClickListener, GoogleMap.OnPolygonClickListener {
    ...
    @OnClick({R.id.ivBack, R.id.tvBookingReq,R.id.ivChat,R.id.ivCall})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.ivBack:
                ...
                break;
                case R.id.ivChat:
                   Intent intent = new Intent(BookingRequestActivity.this, ChatActivity.class);
            ...
            case R.id.tvBookingReq:
                final AlertDialog.Builder builder = new AlertDialog.Builder(BookingRequestActivity.this,R.style.CustomAlertDialog);
                ViewGroup viewGroup = findViewById(android.R.id.content);
                View dialogView = LayoutInflater.from(view.getContext()).inflate(R.layout.dialog_booking, viewGroup, false);
