...
public class PromoActivity extends AppCompatActivity implements OnMapReadyCallback, LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, GoogleMap.OnPolylineClickListener, GoogleMap.OnPolygonClickListener {
    ...
    @OnClick({R.id.ivBack, R.id.cvMenu, R.id.tvAplay})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.cvMenu:
                ...
                break;
            case R.id.tvAplay:
                Intent intent=new Intent(PromoActivity.this,BookingRequestActivity.class);
