...
const MapView = ({ 
  ...
  useEffect(() => {
    ...
    if (pickupLocation?.address && destinationLocation?.address && showRoute) {
      const request = {
      ...
      directionsService.route(request, (result, status) => {
        if (status === google.maps.DirectionsStatus.OK) {
          ...
          // Fit map to show entire route (but keep user location visible if possible)
