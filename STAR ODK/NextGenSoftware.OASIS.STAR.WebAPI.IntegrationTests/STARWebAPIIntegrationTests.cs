...
public class STARWebAPIIntegrationTests
{
    ...
    // The following tests require a live OASIS storage provider to be configured.
    // Without one, STARAPI property getters throw OASISException.
    // They are skipped here and enabled in the integration CI environment.

    [Fact(Skip = "Requires live OASIS provider — enable in integration CI")]
