                ...
                try
                {
                    ...
                    if (inputArgs != null && inputArgs.Length > 0)
                    {
                            switch (inputArgs[0].ToLower())
                            {
                                ...
                                case "light":
                                    await HandleLightCommandAsync(inputArgs, providerType, shellMode);
                                    break;
                                ...
                                case "wiz":
                                    await HandleWizCommandAsync(inputArgs, providerType, shellMode);
                                    break;
                                ...
                                case "game":
                                    await HandleGameCommandAsync(inputArgs, providerType);
                                    break;
