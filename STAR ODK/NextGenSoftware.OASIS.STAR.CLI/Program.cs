                        ...
                        if (inputArgs.Length > 0)
                        {
                            switch (inputArgs[0].ToLower())
                            {
                                ...
                                case "nft":
                                    {
                                       if (inputArgs.Length > 1 && inputArgs[1].ToLower() == "collection")
                                            await ShowSubCommandAsync<STARNFTCollection>(inputArgs, "nft collection", "nft collection's", STARCLI.NFTCollections.CreateAsync, STARCLI.NFTs.EditAsync, STARCLI.NFTs.DeleteAsync, STARCLI.NFTs.DownloadAndInstallAsync, STARCLI.NFTs.UninstallAsync, STARCLI.NFTs.PublishAsync, STARCLI.NFTs.UnpublishAsync, STARCLI.NFTs.RepublishAsync, STARCLI.NFTs.ActivateAsync, STARCLI.NFTs.DeactivateAsync, STARCLI.NFTs.ShowAsync, STARCLI.NFTs.ListAllCreatedByBeamedInAvatarAsync, STARCLI.NFTs.ListAllAsync, STARCLI.NFTs.ListAllInstalledForBeamedInAvatarAsync, STARCLI.NFTs.ListAllUninstalledForBeamedInAvatarAsync, STARCLI.NFTs.ListAllUnpublishedForBeamedInAvatarAsync, STARCLI.NFTs.ListAllDeactivatedForBeamedInAvatarAsync, STARCLI.NFTs.SearchAsync, STARCLI.NFTs.AddDependencyAsync, STARCLI.NFTs.RemoveDependencyAsync, createWeb4NFTCollectionPredicate: STARCLI.NFTs.CreateWeb4NFTCollectionAsync, updateWeb4NFTCollectionPredicate: STARCLI.NFTs.UpdateWeb4NFTCollectionAsync, addWeb4NFTToCollectionPredicate: STARCLI.NFTs.AddWeb4NFTToCollectionAsync, removeWeb4NFTFromCollectionPredicate: STARCLI.NFTs.RemoveWeb4NFTFromCollectionAsync, deleteWeb4NFTCollectionPredicate: STARCLI.NFTs.DeleteWeb4NFTCollectionAsync, listAllWeb4NFTsPredicate: STARCLI.NFTs.ListAllWeb4NFTCollections, listWeb4NFTsForBeamedInAvatarPredicate: STARCLI.NFTs.ListWeb4NFTCollectionsForAvatar, showWeb4NFTPredicate: STARCLI.NFTs.ShowWeb4NFTCollectionAsync, searchWeb4NFTPredicate: STARCLI.NFTs.SearchWeb4NFTCollectionAsync, providerType: providerType);
                                       else
                                ...
                                case "geonft":
                                    {
                                        if (inputArgs.Length > 1 && inputArgs[1].ToLower() == "collection")
                                            await ShowSubCommandAsync<OAPPTemplate>(inputArgs, "geo-nft collection", "geo-nft collection's", STARCLI.OAPPTemplates.CreateAsync, STARCLI.OAPPTemplates.EditAsync, STARCLI.OAPPTemplates.DeleteAsync, STARCLI.OAPPTemplates.DownloadAndInstallAsync, STARCLI.OAPPTemplates.UninstallAsync, STARCLI.OAPPTemplates.PublishAsync, STARCLI.OAPPTemplates.UnpublishAsync, STARCLI.OAPPTemplates.RepublishAsync, STARCLI.OAPPTemplates.ActivateAsync, STARCLI.OAPPTemplates.DeactivateAsync, STARCLI.OAPPTemplates.ShowAsync, STARCLI.OAPPTemplates.ListAllCreatedByBeamedInAvatarAsync, STARCLI.OAPPTemplates.ListAllAsync, STARCLI.OAPPTemplates.ListAllInstalledForBeamedInAvatarAsync, STARCLI.OAPPTemplates.ListAllUninstalledForBeamedInAvatarAsync, STARCLI.OAPPTemplates.ListAllUnpublishedForBeamedInAvatarAsync, STARCLI.OAPPTemplates.ListAllDeactivatedForBeamedInAvatarAsync, STARCLI.OAPPTemplates.SearchAsync, STARCLI.OAPPTemplates.AddDependencyAsync, STARCLI.OAPPTemplates.RemoveDependencyAsync, providerType: providerType);
                                        else
