...
namespace NextGenSoftware.OASIS.STAR.WebAPI.Controllers
{
    ...
    public class AvatarController : STARControllerBase
    {
        ...
        public async Task<IActionResult> AddItemToInventory([FromBody] InventoryItem inventoryItem)
        {
            ...
            // Serialize to JSON for forwarding to Web4
    ...
    /// <summary>Request body for adding XP to the authenticated avatar (STAR forwards to WEB4 add-xp).</summary>
