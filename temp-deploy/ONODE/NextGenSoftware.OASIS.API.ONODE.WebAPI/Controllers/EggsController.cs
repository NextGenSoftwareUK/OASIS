...
namespace NextGenSoftware.OASIS.API.ONODE.WebAPI.Controllers
{
    ...
    public class EggsController : OASISControllerBase
    {
        ...
        public async Task<OASISResult<List<Egg>>> GetAllEggs()
        {
            ...
            return await EggsManager.Instance.GetAllEggsAsync();
        }
        ...
        {
            // Use EggsManager for business logic
            return await EggsManager.Instance.GetCurrentEggQuestsAsync();
        }
        ...
        public async Task<OASISResult<List<EggQuestLeaderboardEntry>>> GetCurrentEggQuestLeaderBoard()
        {
            // Use EggsManager for business logic
            return await EggsManager.Instance.GetCurrentEggQuestLeaderboardAsync();
        }
        ...
        {
            // Use EggsManager for business logic
            return await EggsManager.Instance.GetAvatarEggsAsync(Avatar.Id);
        }
        ...
        [Authorize]
        [HttpPost("discover")]
        public async Task<OASISResult<Egg>> DiscoverEgg([FromBody] Guid locationId, [FromQuery] EggDiscoveryMethod discoveryMethod = EggDiscoveryMethod.Exploration)
        {
            // Use EggsManager for business logic
            return await EggsManager.Instance.DiscoverEggAsync(Avatar.Id, locationId, discoveryMethod);
        }
        ...
        public async Task<OASISResult<EggHatchResult>> HatchEgg(Guid eggId)
        {
            // Use EggsManager for business logic
        ...
        {
            // Use EggsManager for business logic
            return await EggsManager.Instance.UpdateEggGalleryPositionAsync(Avatar.Id, eggId, position);
        }
    }
}
