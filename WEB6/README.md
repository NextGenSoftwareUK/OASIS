...
**250 MCP tools · 56 REST endpoints · 15+ AI providers · .NET 10**
...
| [`NextGenSoftware.OASIS.MCP.Server`](NextGenSoftware.OASIS.MCP.Server/) | `NextGenSoftware.OASIS.MCP.Server` · `@oasisomniverse/mcp-server` | MCP Server — 250 typed tools for IDEs |
...
### MCP Server
Exposes the full WEB4–WEB10 stack as 250 typed named tools directly inside Cursor, VS Code, and Claude Desktop. See [MCP Server README](NextGenSoftware.OASIS.MCP.Server/README.md).
