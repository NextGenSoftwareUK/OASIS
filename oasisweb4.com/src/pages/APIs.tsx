...
const web6Apis = [
  { name: 'AI COMPLETION', desc: 'Unified completion across 100 providers — OpenAI, Anthropic, Gemini, Groq, Mistral, and more. Auto routing, failover, streaming SSE, native tool/function calling.' },
