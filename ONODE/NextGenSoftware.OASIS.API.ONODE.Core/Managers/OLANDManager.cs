    ...
    public class OLandManager : OASISManager
    {
        ...
        public async Task<OASISResult<PurchaseOlandResponse>> PurchaseOlandAsync(PurchaseOlandRequest request)
        {
            ...
            try
            {
                ...
                {
                    OASISResult<IWeb4NFT> mintResult = await _nftManager.MintNftAsync(new MintWeb4NFTRequest()
                    {
                    ...
                    //OASISResult<IWeb4NFTTransactionRespone> nftTransactionResponse = await _nftManager.SendNFTAsync(new NFTWalletTransactionRequest()
                    //{
