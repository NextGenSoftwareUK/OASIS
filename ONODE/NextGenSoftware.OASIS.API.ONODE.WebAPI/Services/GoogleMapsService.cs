...
namespace NextGenSoftware.OASIS.API.ONODE.WebAPI.Services
{
    public class GoogleMapsService
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var requestUri = $"https://maps.googleapis.com/maps/api/distancematrix/json?origins={origins}&destinations={destinations}&key={_options.GoogleMaps.ApiKey}";
                ...
                var element = payload.RootElement.GetProperty("rows")[0].GetProperty("elements")[0];
        ...
        private bool UseMocking()
            => string.IsNullOrWhiteSpace(_options.GoogleMaps?.ApiKey) || _options.GoogleMaps.UseMocks;
    ...
    public class LocationLookupResult
    {
        ...
        public static LocationLookupResult Success(RideLocation location) => new(true, location, null, false);
        public static LocationLookupResult Error(string message) => new(false, null, message, false);
