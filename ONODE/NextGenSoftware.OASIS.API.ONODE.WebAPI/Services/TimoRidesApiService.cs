    ...
    public class TimoRidesApiService
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                result.Result = JsonSerializer.Deserialize<TimoBookingResponse>(rawBody, _serializerOptions);
            }
            catch (Exception ex)
            {
        ...
        public async Task<OASISResult<bool>> CancelBookingAsync(string bookingId, string reason, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var payload = JsonSerializer.Serialize(new { bookingId, reason }, _serializerOptions);
        ...
        private async Task<string> EnsureAccessTokenAsync(CancellationToken cancellationToken)
        {
            ...
            var payload = JsonSerializer.Serialize(new { email = serviceEmail, password = servicePassword }, _serializerOptions);
