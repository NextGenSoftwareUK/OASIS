...
class OASISKeysAPI {
  ...
  async linkPrivateKey(
    ...
    return this.request<boolean>('link_provider_private_key_to_avatar_by_id', {
      method: 'POST',
      body: JSON.stringify({
        AvatarID: avatarId,
        ProviderType: providerType,
        ProviderKey: privateKey,
        WalletId: '00000000-0000-0000-0000-000000000000', // Will be generated by backend
      }),
    });
  }
  ...
  async linkPublicKey(
    ...
    return this.request<boolean>('link_provider_public_key_to_avatar_by_id', {
      method: 'POST',
      body: JSON.stringify({
        AvatarID: avatarId,
        ProviderType: providerType,
