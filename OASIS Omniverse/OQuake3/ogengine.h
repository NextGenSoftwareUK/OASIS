 ...
 *
 * The build script (BUILD_OQUAKE3.bat / BUILD_OQUAKE3.sh) copies the latest version
 * from OGEngineClient into this folder and into the Quake3e source tree automatically.
 *
...
/* Run BUILD_OQUAKE3.bat or BUILD_OQUAKE3.sh to populate the Code\ folder with the real   */
