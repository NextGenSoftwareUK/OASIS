# Start WEB4 and WEB5 APIs (root Scripts), run OGEngineClient test harness against real APIs, then stop APIs.
...
try {
    ...
    try {
        Write-Host ""
        Write-Host "Running STAR API Client test harness against real APIs (WEB5 :8888, WEB4 :7777)..." -ForegroundColor Cyan
