#!/usr/bin/env bash
# Build and deploy OGEngineClient native library + ogengine.h on Linux/macOS.
# Unix equivalent of publish_and_deploy_ogengine.bat (which runs the Windows-only publish_and_deploy_ogengine.ps1).
