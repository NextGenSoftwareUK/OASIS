/**
 * OASIS STAR API - ogengine_sync_* implementation in C# (alternative to star_sync.c).
...
public static unsafe class StarSyncExports
{
    ...
    private static ogengine_item_list_t* _invList;
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_init", CallConvs = [typeof(CallConvCdecl)])]
    public static void StarSyncInit()
    {
        _initialized = true;
    }

    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_cleanup", CallConvs = [typeof(CallConvCdecl)])]
    public static void StarSyncCleanup()
    {
        ...
        lock (InvLock)
        {
            if (_invList != null)
            {
                OGEngineExports.FreeItemListInternal(_invList);
                _invList = null;
            }
            _invHasResult = 0;
        }
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_set_add_item_log_cb", CallConvs = [typeof(CallConvCdecl)])]
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_pump", CallConvs = [typeof(CallConvCdecl)])]
            ...
            try
            {
                switch (action.Kind)
                {
                    ...
                    case PumpActionKind.OperationCallback:
                        OGEngineExports.InvokeOperationCallbackOnCurrentThread((StarApiResultCode)action.OpResultCode, action.OpType);
                        break;
                }
            }
    ...
    {
        const int sizeOfItem = 256 + 512 + 64 + 64 + 128 + 4; // ogengine_sync_local_item_t
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_auth_start", CallConvs = [typeof(CallConvCdecl)])]
    ...
    {
        var user = OGEngineExports.PtrToString(username) ?? string.Empty;
        var pass = OGEngineExports.PtrToString(password) ?? string.Empty;
        lock (AuthLock)
        {
        ...
        _ = Task.Run(() =>
        {
            ...
            var client = OGEngineExports.GetClient();
            if (client != null)
            {
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_auth_poll", CallConvs = [typeof(CallConvCdecl)])]
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_auth_get_result", CallConvs = [typeof(CallConvCdecl)])]
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_auth_get_result_jwt", CallConvs = [typeof(CallConvCdecl)])]
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_auth_in_progress", CallConvs = [typeof(CallConvCdecl)])]
    public static int StarSyncAuthInProgress()
    {
        lock (AuthLock) return _authInProgress;
    }

    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_auth_force_reset", CallConvs = [typeof(CallConvCdecl)])]
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_inventory_start", CallConvs = [typeof(CallConvCdecl)])]
    public static void StarSyncInventoryStart(ogengine_sync_local_item_t* localItems, int localCount, sbyte* defaultGameSource, delegate* unmanaged[Cdecl]<void*, void> onDone, void* onDoneUser)
    {
        var defaultSrc = OGEngineExports.PtrToString(defaultGameSource) ?? string.Empty;
        lock (InvLock)
        {
        ...
        _ = Task.Run(() =>
        {
            ...
            if (client != null)
            {
                ...
                {
                    list = OGEngineExports.BuildItemListFromInventory(invResult.Result);
    ...
    private static List<LocalItemCopy>? CopyLocalItems(ogengine_sync_local_item_t* localItems, int localCount)
    {
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_inventory_poll", CallConvs = [typeof(CallConvCdecl)])]
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_inventory_get_result", CallConvs = [typeof(CallConvCdecl)])]
    public static int StarSyncInventoryGetResult(ogengine_item_list_t** listOut, int* resultOut, sbyte* errorMsgBuf, nuint errorMsgSize)
    {
        lock (InvLock)
        {
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_inventory_clear_result", CallConvs = [typeof(CallConvCdecl)])]
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_inventory_deliver_result", CallConvs = [typeof(CallConvCdecl)])]
    public static void StarSyncInventoryDeliverResult(ogengine_item_list_t* list, int result, sbyte* errorMsg)
    {
        var err = OGEngineExports.PtrToString(errorMsg) ?? string.Empty;
        lock (InvLock)
        {
            _invInProgress = 0;
            _invHasResult = 1;
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_inventory_in_progress", CallConvs = [typeof(CallConvCdecl)])]
    public static int StarSyncInventoryInProgress()
    {
        lock (InvLock) return _invInProgress;
    }

    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_single_item", CallConvs = [typeof(CallConvCdecl)])]
    public static int StarSyncSingleItem(sbyte* name, sbyte* description, sbyte* gameSource, sbyte* itemType, sbyte* nftId)
    {
        var nameStr = OGEngineExports.PtrToString(name);
        ...
        client.EnqueueAddItemJobOnly(
            nameStr,
            OGEngineExports.PtrToString(description) ?? string.Empty,
            OGEngineExports.PtrToString(gameSource) ?? string.Empty,
            OGEngineExports.PtrToString(itemType) ?? "KeyItem",
            OGEngineExports.PtrToString(nftId),
            1,
            true);
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_send_item_start", CallConvs = [typeof(CallConvCdecl)])]
    ...
    {
        var targetStr = OGEngineExports.PtrToString(target) ?? string.Empty;
        var itemNameStr = OGEngineExports.PtrToString(itemName) ?? string.Empty;
        var itemIdStr = OGEngineExports.PtrToString(itemId);
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_send_item_poll", CallConvs = [typeof(CallConvCdecl)])]
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_send_item_get_result", CallConvs = [typeof(CallConvCdecl)])]
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_send_item_in_progress", CallConvs = [typeof(CallConvCdecl)])]
    public static int StarSyncSendItemInProgress()
    {
        lock (SendLock) return _sendInProgress;
    }

    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_use_item_start", CallConvs = [typeof(CallConvCdecl)])]
    ...
    {
        var itemNameStr = OGEngineExports.PtrToString(itemName) ?? string.Empty;
        var contextStr = OGEngineExports.PtrToString(context);
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_use_item_get_result", CallConvs = [typeof(CallConvCdecl)])]
    ...
    [UnmanagedCallersOnly(EntryPoint = "ogengine_sync_use_item_in_progress", CallConvs = [typeof(CallConvCdecl)])]
