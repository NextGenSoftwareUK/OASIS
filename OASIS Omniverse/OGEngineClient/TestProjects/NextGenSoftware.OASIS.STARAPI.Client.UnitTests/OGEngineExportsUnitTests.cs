...
public unsafe class OGEngineExportsUnitTests
{
    [Fact]
    public void StarApiInit_NullConfig_ReturnsInvalidParam_AndSetsError()
    {
        delegate* unmanaged[Cdecl]<ogengine_config_t*, int> initPtr = &OGEngineExports.StarApiInit;
        delegate* unmanaged[Cdecl]<sbyte*> getLastErrorPtr = &OGEngineExports.StarApiGetLastError;
        ...
        delegate* unmanaged[Cdecl]<void> cleanupPtr = &OGEngineExports.StarApiCleanup;
        cleanupPtr();
    }
    ...
    public void StarApiInit_NativeTransport_ReturnsInitFailed()
    {
        ...
        try
        {
            var config = new ogengine_config_t
            {
                base_url = baseUrlPtr,
                timeout_seconds = 30,
                transport = (int)OGEngineTransport.Native
            };
    ...
    {
        delegate* unmanaged[Cdecl]<sbyte*, int> setWeb4Ptr = &OGEngineExports.StarApiSetOasisBaseUrl;
        delegate* unmanaged[Cdecl]<sbyte*> getLastErrorPtr = &OGEngineExports.StarApiGetLastError;
        delegate* unmanaged[Cdecl]<void> cleanupPtr = &OGEngineExports.StarApiCleanup;
    ...
    {
        delegate* unmanaged[Cdecl]<ogengine_item_list_t**, int> getInventoryPtr = &OGEngineExports.StarApiGetInventory;
        delegate* unmanaged[Cdecl]<sbyte*> getLastErrorPtr = &OGEngineExports.StarApiGetLastError;
    ...
    public void StarApiConsumeLastMintResult_WhenNoMint_ReturnsZero()
    {
        delegate* unmanaged[Cdecl]<void> cleanupPtr = &OGEngineExports.StarApiCleanup;
        delegate* unmanaged[Cdecl]<ogengine_config_t*, int> initPtr = &OGEngineExports.StarApiInit;
        delegate* unmanaged[Cdecl]<sbyte*, nuint, sbyte*, nuint, sbyte*, nuint, int> consumePtr = &OGEngineExports.StarApiConsumeLastMintResult;

        cleanupPtr();
        var baseUrlPtr = StringToNativeUtf8("https://web5.example.com/api");
        try
        {
            var config = new ogengine_config_t { base_url = baseUrlPtr, timeout_seconds = 30 };
            initPtr(&config);
