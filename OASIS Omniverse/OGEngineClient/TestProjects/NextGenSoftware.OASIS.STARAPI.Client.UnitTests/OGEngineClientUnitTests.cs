...
public class OGEngineClientUnitTests
{
    [Fact]
    public void Init_WithMissingWeb5BaseUrl_ReturnsInvalidParam()
    {
        using var client = new OGEngineClient();

        var result = client.Init(new OGEngineConfig { Web5StarApiBaseUrl = string.Empty });
    ...
    public void Init_WithInvalidWeb5BaseUrl_ReturnsInvalidParam()
    {
        ...
        var result = client.Init(new OGEngineConfig { Web5StarApiBaseUrl = "not-a-uri" });
    ...
    public void Init_WithNativeTransport_ReturnsInitFailed()
    {
        ...
        var result = client.Init(new OGEngineConfig
        {
            Transport = OGEngineTransport.Native,
    ...
    {
        using var client = new OGEngineClient();
        var config = new OGEngineConfig { Web5StarApiBaseUrl = "https://web5.example.com/api" };
    ...
    {
        using var client = new OGEngineClient();
        client.Init(new OGEngineConfig { Web5StarApiBaseUrl = "https://web5.example.com/api" });
    ...
    {
        using var client = new OGEngineClient();
        client.Init(new OGEngineConfig { Web5StarApiBaseUrl = "https://web5.example.com" });
    ...
    {
        var serialized = OGEngineClient.SerializeQuestsForGame(new List<StarQuestInfo>());
    ...
    {
        var serialized = OGEngineClient.SerializeQuestsForGame(null);
        Assert.NotNull(serialized);
        Assert.Empty(serialized);
    }
    ...
    public void SerializeQuestsForGame_WithObjectives_IncludesObjectiveLines()
    {
        ...
        var serialized = OGEngineClient.SerializeQuestsForGame(quests);
        Assert.NotNull(serialized);
    ...
    {
        using var client = new OGEngineClient();
        client.Init(new OGEngineConfig { Web5StarApiBaseUrl = "http://localhost:8888", Web4OasisApiBaseUrl = "http://localhost:7777" });
