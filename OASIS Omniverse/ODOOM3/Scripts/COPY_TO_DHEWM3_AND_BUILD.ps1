...
.DESCRIPTION
    Run this after editing d3doom3_star_integration.cpp/.h, OGLib, or star_api.h.
...
$IntegrationFiles = @(
    "d3doom3_star_integration.h",
    "d3doom3_star_integration.cpp"
)
...
# Deploy star_api.dll next to the dhewm3 executable
