...
$OGamesRoot = Split-Path -Parent $OasisDir
$OGLibDir   = Join-Path (Split-Path -Parent $OGamesRoot) "OGLib"
$StarDir    = Join-Path (Split-Path -Parent $OGamesRoot) "OGEngineClient"
