...
/** Call at map load. Polls for an incoming teleport request from OmniverseKernel.
 *  If one is pending, warps the player to the target position via g_edicts[1] + gi.linkentity
 *  and confirms arrival. */
