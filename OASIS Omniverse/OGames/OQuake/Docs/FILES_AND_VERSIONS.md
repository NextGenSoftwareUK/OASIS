...
| **build/** | Build output (OQUAKE.exe, ogengine.dll); regenerated by build. |
...
| File | Description |
|------|-------------|
| **BUILD_OQUAKE.bat** | Build star_api, copy OQuake + STAR into quake-rerelease-qc (and vkQuake if set), build engine; copies OQUAKE.exe + ogengine.dll to `build\`. |
...
| File | Description |
|------|-------------|
| **Code/oquake_ogengine_integration.c** | STAR init, key pickup, door check. |
| **Code/oquake_ogengine_integration.h** | Declarations. |
