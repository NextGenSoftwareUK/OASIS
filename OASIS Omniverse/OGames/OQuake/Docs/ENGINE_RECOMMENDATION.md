...
- **BUILD_OQUAKE.bat** – Script can clone vkQuake, copy OQuake/STAR files into `Quake/`, build, and copy **OQUAKE.exe** and **ogengine.dll** into `OASIS Omniverse\OQuake\build\`.
...
3. Follow **vkquake_oquake\VKQUAKE_OQUAKE_INTEGRATION.md** for host.c, pr_ext.c, and project changes (the apply script copies files; you still add sources and link ogengine.lib).
