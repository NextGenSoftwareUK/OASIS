...
{
    public class Web3NFT : IWeb3NFT
    {
        //public Guid MintedByAvatarId { get; set; }
        //public Guid ImportedByAvatarId { get; set; }
        //public string NFTTokenId { get; set; } //TODO: What is the difference between this and NFTTokenAddress?
        ...
        public string JSONMetaData { get; set; } //Will be the same as the parent WEB4 OASIS NFT (may not be needed here). Unless the Web3Request chooses to override it...
        public string JSONMetaDataURL { get; set; } //Will be the same as the parent WEB4 OASIS NFT. (may not be needed here). Unless the Web3Request chooses to override it...
        public Guid JSONMetaDataURLHolonId { get; set; } //Will be the same as the parent WEB4 OASIS NFT. (may not be needed here). Unless the Web3Request chooses to override it...
