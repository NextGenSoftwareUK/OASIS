...
namespace NextGenSoftware.OASIS.API.Core.Managers
{
    ...
    public class BridgeManager : OASISManager
    {
            ...
            CancellationToken token = default)
        {
            ...
            try
            {
                ...
                // TODO: CreateNFTBridgeOrderAsync not yet implemented in ICrossChainBridgeManager
                // return await _crossChainBridgeManager.CreateNFTBridgeOrderAsync(request, token);
                result.IsError = true;
                result.Message = "CreateNFTBridgeOrderAsync not yet implemented";
                return result;
            }
            catch (Exception ex)
            {
    ...
    internal class ProviderBridgeAdapter : IOASISBridge
    {
        ...
        {
            // TODO: CreateAccountAsync not yet implemented in IOASISBlockchainStorageProvider
            // return await _provider.CreateAccountAsync(token);
            return new OASISResult<(string PublicKey, string PrivateKey, string SeedPhrase)>
            {
                IsError = true,
                Message = "CreateAccountAsync not yet implemented"
            };
        }

        public async Task<OASISResult<(string PublicKey, string PrivateKey)>> RestoreAccountAsync(string seedPhrase, CancellationToken token = default)
        {
            // TODO: RestoreAccountAsync not yet implemented in IOASISBlockchainStorageProvider
            // return await _provider.RestoreAccountAsync(seedPhrase, token);
            return new OASISResult<(string PublicKey, string PrivateKey)>
            {
                IsError = true,
                Message = "RestoreAccountAsync not yet implemented"
            };
        }

        public async Task<OASISResult<BridgeTransactionResponse>> WithdrawAsync(decimal amount, string senderAccountAddress, string senderPrivateKey)
        {
            // TODO: WithdrawAsync not yet implemented in IOASISBlockchainStorageProvider
            ...
            {
                IsError = true,
                Message = "WithdrawAsync not yet implemented"
            };
        }

        public async Task<OASISResult<BridgeTransactionResponse>> DepositAsync(decimal amount, string receiverAccountAddress)
        {
            // TODO: DepositAsync not yet implemented in IOASISBlockchainStorageProvider
            // return await _provider.DepositAsync(amount, receiverAccountAddress);
            return new OASISResult<BridgeTransactionResponse>
            {
                IsError = true,
                Message = "DepositAsync not yet implemented"
            };
        }

        public async Task<OASISResult<BridgeTransactionStatus>> GetTransactionStatusAsync(string transactionHash, CancellationToken token = default)
        {
            // TODO: GetTransactionStatusAsync not yet implemented in IOASISBlockchainStorageProvider
            // return await _provider.GetTransactionStatusAsync(transactionHash, token);
            return new OASISResult<BridgeTransactionStatus>
            {
                IsError = true,
                Message = "GetTransactionStatusAsync not yet implemented"
            };
        }
