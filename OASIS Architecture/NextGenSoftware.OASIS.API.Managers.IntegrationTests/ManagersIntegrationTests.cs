...
using NextGenSoftware.OASIS.API.Managers;
using NextGenSoftware.OASIS.Common;
using Xunit;
using FluentAssertions;

namespace NextGenSoftware.OASIS.API.Managers.IntegrationTests;

public class ManagersIntegrationTests
{
    [Fact]
    public async Task AvatarManager_Should_Initialize_Successfully()
    {
        // Arrange & Act
    ...
    [Fact]
    public async Task HolonManager_Should_Initialize_Successfully()
    {
        // Arrange & Act
    ...
    [Fact]
    public async Task KeyManager_Should_Initialize_Successfully()
    {
        // Arrange & Act
    ...
    [Fact]
    public async Task MapManager_Should_Initialize_Successfully()
    {
        // Arrange & Act
    ...
    [Fact]
    public async Task NFTManager_Should_Initialize_Successfully()
    {
        // Arrange & Act
    ...
    [Fact]
    public async Task SearchManager_Should_Initialize_Successfully()
    {
        // Arrange & Act
    ...
    [Fact]
    public async Task WalletManager_Should_Initialize_Successfully()
    {
        // Arrange & Act
    ...
    [Fact]
    public async Task AvatarManager_Should_Handle_Provider_Type_Changes()
    {
        // Arrange
        var avatarManager = new AvatarManager();
    ...
    [Fact]
    public async Task HolonManager_Should_Handle_Provider_Type_Changes()
    {
        // Arrange
        var holonManager = new HolonManager();
    ...
    [Fact]
    public async Task KeyManager_Should_Handle_Provider_Type_Changes()
    {
        // Arrange
        var keyManager = new KeyManager();
    ...
    [Fact]
    public async Task MapManager_Should_Handle_Provider_Type_Changes()
    {
        // Arrange
        var mapManager = new MapManager();
    ...
    [Fact]
    public async Task NFTManager_Should_Handle_Provider_Type_Changes()
    {
        // Arrange
        var nftManager = new NFTManager();
    ...
    [Fact]
    public async Task SearchManager_Should_Handle_Provider_Type_Changes()
    {
        // Arrange
        var searchManager = new SearchManager();
    ...
    [Fact]
    public async Task WalletManager_Should_Handle_Provider_Type_Changes()
    {
        // Arrange
        var walletManager = new WalletManager();
