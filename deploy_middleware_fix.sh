...
echo "🚀 Deploying OASIS middleware configuration override fix..."
...
# 2. Build the Docker image with the middleware fix
echo "Building Docker image: ${FULL_IMAGE_NAME}..."
docker build -f Dockerfile.middleware-update -t ${FULL_IMAGE_NAME} .
if [ $? -ne 0 ]; then
...
if [ $? -ne 0 ]; then
    ...
    echo "✅ OASIS middleware configuration override fix deployment completed!"
    ...
    echo ""
    echo "⚠️  IMPORTANT: The middleware configuration override fix is now deployed!"
