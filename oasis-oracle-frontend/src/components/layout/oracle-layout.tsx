...
import { Activity, TrendingUp, CheckCircle2, Coins, Shuffle, Image, Vote, Wallet } from "lucide-react";
...
const navItems = [
  ...
  { label: "NFT Transfer", href: "/nft-transfer", icon: Image },
  { label: "DAO Voting", href: "/dao", icon: Vote },
];
