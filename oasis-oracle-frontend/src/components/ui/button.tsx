...
const baseStyles = "inline-flex items-center justify-center gap-2 rounded-lg px-4 py-2 text-sm font-medium transition focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50";
...
const variantStyles: Record<NonNullable<ButtonProps["variant"]>, string> = {
  ...
  danger:
    "bg-[var(--negative)] text-white shadow-[0_20px_40px_rgba(239,68,68,0.25)] hover:bg-[rgba(239,68,68,0.9)] focus-visible:ring-[var(--negative)] focus-visible:ring-offset-0",
};
...
export type ButtonProps = DetailedHTMLProps<
  ...
  HTMLButtonElement
> & {
  variant?: "primary" | "outline" | "ghost" | "secondary" | "toggle" | "danger";
  "data-state"?: string;
};
