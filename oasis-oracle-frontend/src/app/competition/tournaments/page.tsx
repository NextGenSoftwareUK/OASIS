...
import { Trophy, Crown, Medal, Star, Users, Target, Zap } from 'lucide-react';
      ...
      const mockTournaments: Tournament[] = [
        {
          ...
          registrationStart: '2025-11-08T00:00:00Z',
          registrationEnd: '2025-11-15T09:00:00Z',
          maxParticipants: 64,
        ...
        },
        {
          ...
          registrationStart: '2025-11-03T00:00:00Z',
          registrationEnd: '2025-11-10T00:00:00Z',
          maxParticipants: 32,
    ...
    try {
      ...
      const mockStats: TournamentStats = {
        ...
        participationHistory: [
          { date: '2025-11-01', tournaments: 2, wins: 1 },
          { date: '2025-11-08', tournaments: 1, wins: 1 },
          { date: '2025-11-15', tournaments: 3, wins: 2 }
        ]
      };
      setStats(mockStats);
    } catch (error) {
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button variant="outline" className="text-xs px-3 py-1.5">View Details</Button>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button className="text-xs px-3 py-1.5">Join Tournament</Button>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
