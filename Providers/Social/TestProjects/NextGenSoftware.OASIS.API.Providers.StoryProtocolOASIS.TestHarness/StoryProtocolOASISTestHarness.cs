...
namespace NextGenSoftware.OASIS.API.Providers.StoryProtocolOASIS.TestHarness
{
    ...
    /// Configure with STORYPROTOCOLOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class StoryProtocolOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("StoryProtocolOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = StoryProtocolOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the STORYPROTOCOLOASIS_* environment variables and try again.");
                return;
            }
