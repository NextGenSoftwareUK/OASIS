...
namespace NextGenSoftware.OASIS.API.Providers.LensOASIS.TestHarness
{
    ...
    /// Configure with LENSOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class LensOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("LensOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = LensOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the LENSOASIS_* environment variables and try again.");
                return;
            }
