...
namespace NextGenSoftware.OASIS.API.Providers.NostrOASIS.TestHarness
{
    ...
    /// Configure with NOSTROASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class NostrOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("NostrOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = NostrOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the NOSTROASIS_* environment variables and try again.");
                return;
            }
