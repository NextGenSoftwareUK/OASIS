...
namespace NextGenSoftware.OASIS.API.Providers.LoomOASIS.TestHarness
{
    ...
    /// Configure with LOOMOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class LoomOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("LoomOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = LoomOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the LOOMOASIS_* environment variables and try again.");
                return;
            }
