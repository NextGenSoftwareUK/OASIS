...
namespace NextGenSoftware.OASIS.API.Providers.MatrixOASIS.TestHarness
{
    ...
    /// Configure with MATRIXOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class MatrixOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("MatrixOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = MatrixOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the MATRIXOASIS_* environment variables and try again.");
                return;
            }
