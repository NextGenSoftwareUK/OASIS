...
namespace NextGenSoftware.OASIS.API.Providers.DiscordOASIS.TestHarness
{
    ...
    /// Configure with DISCORDOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class DiscordOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("DiscordOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = DiscordOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the DISCORDOASIS_* environment variables and try again.");
                return;
            }
