...
namespace NextGenSoftware.OASIS.API.Providers.FarcasterOASIS.TestHarness
{
    ...
    /// Configure with FARCASTEROASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class FarcasterOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("FarcasterOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = FarcasterOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the FARCASTEROASIS_* environment variables and try again.");
                return;
            }
