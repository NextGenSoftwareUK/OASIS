...
namespace NextGenSoftware.OASIS.API.Providers.TheGraphOASIS.TestHarness
{
    ...
    /// Configure with THEGRAPHOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class TheGraphOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("TheGraphOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = TheGraphOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the THEGRAPHOASIS_* environment variables and try again.");
                return;
            }
