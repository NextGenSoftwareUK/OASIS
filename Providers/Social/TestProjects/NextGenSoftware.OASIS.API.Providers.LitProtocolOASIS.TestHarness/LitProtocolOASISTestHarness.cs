...
namespace NextGenSoftware.OASIS.API.Providers.LitProtocolOASIS.TestHarness
{
    ...
    /// Configure with LITPROTOCOLOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class LitProtocolOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("LitProtocolOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = LitProtocolOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the LITPROTOCOLOASIS_* environment variables and try again.");
                return;
            }
