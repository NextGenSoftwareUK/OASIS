...
namespace NextGenSoftware.OASIS.API.Providers.DiscordOASIS.IntegrationTests
{
    ...
    ///
    /// Connection details come from DISCORDOASIS_&lt;PARAM&gt; environment variables. When the
    ...
    /// </summary>
    [TestClass]
    public class DiscordOASISIntegrationTests
    {
        ...
        public void Setup()
        {
            _provider = DiscordOASISTestFactory.Create();
        ...
        private void RequireLive()
        {
            if (!_live)
                Assert.Inconclusive(
                    "No live DiscordOASIS backend configured - set the DISCORDOASIS_* environment variables to run this.");
        }
