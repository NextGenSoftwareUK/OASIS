...
namespace NextGenSoftware.OASIS.API.Providers.BlueSkyOASIS.TestHarness
{
    ...
    /// Configure with BLUESKYOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class BlueSkyOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("BlueSkyOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = BlueSkyOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the BLUESKYOASIS_* environment variables and try again.");
                return;
            }
