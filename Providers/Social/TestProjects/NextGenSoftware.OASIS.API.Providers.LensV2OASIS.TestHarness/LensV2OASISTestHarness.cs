...
namespace NextGenSoftware.OASIS.API.Providers.LensV2OASIS.TestHarness
{
    ...
    /// Configure with LENSV2OASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class LensV2OASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("LensV2OASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = LensV2OASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the LENSV2OASIS_* environment variables and try again.");
                return;
            }
