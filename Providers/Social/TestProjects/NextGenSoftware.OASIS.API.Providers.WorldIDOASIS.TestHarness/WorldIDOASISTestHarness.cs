...
namespace NextGenSoftware.OASIS.API.Providers.WorldIDOASIS.TestHarness
{
    ...
    /// Configure with WORLDIDOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class WorldIDOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("WorldIDOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = WorldIDOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the WORLDIDOASIS_* environment variables and try again.");
                return;
            }
