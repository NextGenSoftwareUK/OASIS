...
namespace NextGenSoftware.OASIS.API.Providers.InfuraOASIS.IntegrationTests
{
    ...
    ///
    /// Connection details come from INFURAOASIS_&lt;PARAM&gt; environment variables. When the
    ...
    /// </summary>
    [TestClass]
    public class InfuraOASISIntegrationTests
    {
        ...
        public void Setup()
        {
            _provider = InfuraOASISTestFactory.Create();
        ...
        private void RequireLive()
        {
            if (!_live)
                Assert.Inconclusive(
                    "No live InfuraOASIS backend configured - set the INFURAOASIS_* environment variables to run this.");
        }
