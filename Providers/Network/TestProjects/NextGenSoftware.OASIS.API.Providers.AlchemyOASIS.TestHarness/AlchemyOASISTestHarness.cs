...
namespace NextGenSoftware.OASIS.API.Providers.AlchemyOASIS.TestHarness
{
    ...
    /// Configure with ALCHEMYOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class AlchemyOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("AlchemyOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = AlchemyOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the ALCHEMYOASIS_* environment variables and try again.");
                return;
            }
