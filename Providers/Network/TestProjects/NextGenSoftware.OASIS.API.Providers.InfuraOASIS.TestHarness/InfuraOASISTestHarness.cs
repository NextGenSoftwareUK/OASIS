...
namespace NextGenSoftware.OASIS.API.Providers.InfuraOASIS.TestHarness
{
    ...
    /// Configure with INFURAOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class InfuraOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("InfuraOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = InfuraOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the INFURAOASIS_* environment variables and try again.");
                return;
            }
