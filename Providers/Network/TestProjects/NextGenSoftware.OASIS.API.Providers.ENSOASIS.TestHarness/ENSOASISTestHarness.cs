...
namespace NextGenSoftware.OASIS.API.Providers.ENSOASIS.TestHarness
{
    ...
    /// Configure with ENSOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class ENSOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("ENSOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = ENSOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the ENSOASIS_* environment variables and try again.");
                return;
            }
