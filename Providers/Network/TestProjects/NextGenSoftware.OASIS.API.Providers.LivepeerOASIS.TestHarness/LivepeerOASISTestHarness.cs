...
namespace NextGenSoftware.OASIS.API.Providers.LivepeerOASIS.TestHarness
{
    ...
    /// Configure with LIVEPEEROASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class LivepeerOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("LivepeerOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = LivepeerOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the LIVEPEEROASIS_* environment variables and try again.");
                return;
            }
