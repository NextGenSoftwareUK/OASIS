...
namespace NextGenSoftware.OASIS.API.Providers.GitcoinPassportOASIS.TestHarness
{
    ...
    /// Configure with GITCOINPASSPORTOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class GitcoinPassportOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("GitcoinPassportOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = GitcoinPassportOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the GITCOINPASSPORTOASIS_* environment variables and try again.");
                return;
            }
