...
namespace NextGenSoftware.OASIS.API.Providers.PrivyOASIS.TestHarness
{
    ...
    /// Configure with PRIVYOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class PrivyOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("PrivyOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = PrivyOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the PRIVYOASIS_* environment variables and try again.");
                return;
            }
