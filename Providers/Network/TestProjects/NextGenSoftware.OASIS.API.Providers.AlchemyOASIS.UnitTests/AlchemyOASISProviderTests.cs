...
namespace NextGenSoftware.OASIS.API.Providers.AlchemyOASIS.UnitTests
{
    /// <summary>
    ...
    /// </summary>
    [TestClass]
    public class AlchemyOASISProviderTests
    {
        private AlchemyOASIS _provider = null!;

        [TestInitialize]
        public void Setup() => _provider = AlchemyOASISTestFactory.Create();
