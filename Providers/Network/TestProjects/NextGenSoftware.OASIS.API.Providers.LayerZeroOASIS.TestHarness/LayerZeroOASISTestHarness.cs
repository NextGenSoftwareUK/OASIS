...
namespace NextGenSoftware.OASIS.API.Providers.LayerZeroOASIS.TestHarness
{
    ...
    /// Configure with LAYERZEROOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class LayerZeroOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("LayerZeroOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = LayerZeroOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the LAYERZEROOASIS_* environment variables and try again.");
                return;
            }
