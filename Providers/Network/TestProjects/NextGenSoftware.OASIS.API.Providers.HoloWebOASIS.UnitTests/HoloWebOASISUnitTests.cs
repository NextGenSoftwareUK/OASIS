...
namespace NextGenSoftware.OASIS.API.Providers.HoloWebOASIS.UnitTests
{
    [TestClass]
    public class HoloWebOASISProviderTests
    {
        private HoloWebOASIS _provider;
        ...
        [TestMethod]
        public void ProviderType_ShouldBeHoloWebOASIS()
        {
            // Arrange & Act
            var providerType = _provider.ProviderType;

            // Assert
            Assert.AreEqual(ProviderType.HoloWebOASIS, providerType);
        }
        ...
        [TestMethod]
        public void ProviderName_ShouldBeHoloWebOASIS()
        {
            // Arrange & Act
            var providerName = _provider.ProviderName;

            // Assert
            Assert.AreEqual("HoloWebOASIS", providerName);
        }
