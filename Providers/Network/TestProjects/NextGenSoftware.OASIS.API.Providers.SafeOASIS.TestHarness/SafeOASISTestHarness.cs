...
namespace NextGenSoftware.OASIS.API.Providers.SafeOASIS.TestHarness
{
    ...
    /// Configure with SAFEOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class SafeOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("SafeOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = SafeOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the SAFEOASIS_* environment variables and try again.");
                return;
            }
