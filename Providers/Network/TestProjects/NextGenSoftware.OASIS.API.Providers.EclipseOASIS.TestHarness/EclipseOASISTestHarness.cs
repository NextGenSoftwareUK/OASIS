...
namespace NextGenSoftware.OASIS.API.Providers.EclipseOASIS.TestHarness
{
    ...
    /// Configure with ECLIPSEOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class EclipseOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("EclipseOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = EclipseOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the ECLIPSEOASIS_* environment variables and try again.");
                return;
            }
