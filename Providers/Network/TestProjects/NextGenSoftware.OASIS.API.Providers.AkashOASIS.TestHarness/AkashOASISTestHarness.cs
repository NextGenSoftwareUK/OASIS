...
namespace NextGenSoftware.OASIS.API.Providers.AkashOASIS.TestHarness
{
    ...
    /// Configure with AKASHOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class AkashOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("AkashOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = AkashOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the AKASHOASIS_* environment variables and try again.");
                return;
            }
