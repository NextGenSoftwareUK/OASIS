using NextGenSoftware.OASIS.API.Providers.HoloWebOASIS;
...
namespace NextGenSoftware.OASIS.API.Providers.HoloWebOASIS.TestHarness
{
    public class HoloWebOASISTestHarness
    {
        private static HoloWebOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== HoloWebOASIS Test Harness ===");
            Console.WriteLine("Testing HoloWebOASIS integration with OASIS...\n");

            _provider = new HoloWebOASIS();
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "HoloWebOASISTestUser",
                Email = "holoweboasistest@example.com",
                FirstName = "HoloWebOASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "HoloWebOASISTestHolon",
                Description = "Test Holon for HoloWebOASIS integration",
                CreatedDate = DateTime.UtcNow
            };
