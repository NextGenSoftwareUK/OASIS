...
namespace NextGenSoftware.OASIS.API.Providers.PolybaseOASIS.TestHarness
{
    ...
    /// Configure with POLYBASEOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class PolybaseOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("PolybaseOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = PolybaseOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the POLYBASEOASIS_* environment variables and try again.");
                return;
            }
