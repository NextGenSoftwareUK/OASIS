...
namespace NextGenSoftware.OASIS.API.Providers.MoralisOASIS.UnitTests
{
    /// <summary>
    ...
    /// </summary>
    [TestClass]
    public class MoralisOASISProviderTests
    {
        private MoralisOASIS _provider = null!;

        [TestInitialize]
        public void Setup() => _provider = MoralisOASISTestFactory.Create();
