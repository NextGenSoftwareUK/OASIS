using NextGenSoftware.OASIS.API.Providers.OrionProtocolOASIS;
...
namespace NextGenSoftware.OASIS.API.Providers.OrionProtocolOASIS.TestHarness
{
    public class OrionProtocolOASISTestHarness
    {
        private static OrionProtocolOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== OrionProtocolOASIS Test Harness ===");
            Console.WriteLine("Testing OrionProtocolOASIS integration with OASIS...\n");

            _provider = new OrionProtocolOASIS();
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "OrionProtocolOASISTestUser",
                Email = "orionprotocoloasistest@example.com",
                FirstName = "OrionProtocolOASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "OrionProtocolOASISTestHolon",
                Description = "Test Holon for OrionProtocolOASIS integration",
                CreatedDate = DateTime.UtcNow
            };
