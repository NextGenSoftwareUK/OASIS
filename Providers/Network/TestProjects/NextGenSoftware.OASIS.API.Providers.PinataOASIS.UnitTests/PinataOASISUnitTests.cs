...
namespace NextGenSoftware.OASIS.API.Providers.PinataOASIS.UnitTests
{
    [TestClass]
    public class PinataOASISProviderTests
    {
        private PinataOASIS _provider;

        [TestInitialize]
        public void Setup()
        {
            _provider = new PinataOASIS();
        }

        [TestMethod]
        public void ProviderType_ShouldBePinataOASIS()
        {
            // Arrange & Act
            var providerType = _provider.ProviderType;

            // Assert
            Assert.AreEqual(ProviderType.PinataOASIS, providerType);
        }
        ...
        [TestMethod]
        public void ProviderName_ShouldBePinataOASIS()
        {
            // Arrange & Act
            var providerName = _provider.ProviderName;

            // Assert
            Assert.AreEqual("PinataOASIS", providerName);
        }
