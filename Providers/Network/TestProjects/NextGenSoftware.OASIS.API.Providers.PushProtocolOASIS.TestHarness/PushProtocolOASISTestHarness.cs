...
namespace NextGenSoftware.OASIS.API.Providers.PushProtocolOASIS.TestHarness
{
    ...
    /// Configure with PUSHPROTOCOLOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class PushProtocolOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("PushProtocolOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = PushProtocolOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the PUSHPROTOCOLOASIS_* environment variables and try again.");
                return;
            }
