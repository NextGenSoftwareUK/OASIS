...
namespace NextGenSoftware.OASIS.API.Providers.ZkSyncSSOOASIS.TestHarness
{
    ...
    /// Configure with ZKSYNCSSOOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class ZkSyncSSOOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("ZkSyncSSOOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = ZkSyncSSOOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the ZKSYNCSSOOASIS_* environment variables and try again.");
                return;
            }
