...
namespace NextGenSoftware.OASIS.API.Providers.SuiZkLoginOASIS.TestHarness
{
    ...
    /// Configure with SUIZKLOGINOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class SuiZkLoginOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("SuiZkLoginOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = SuiZkLoginOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the SUIZKLOGINOASIS_* environment variables and try again.");
                return;
            }
