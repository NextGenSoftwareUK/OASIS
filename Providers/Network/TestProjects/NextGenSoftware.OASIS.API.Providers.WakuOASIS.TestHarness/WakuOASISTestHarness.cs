...
namespace NextGenSoftware.OASIS.API.Providers.WakuOASIS.TestHarness
{
    ...
    /// Configure with WAKUOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class WakuOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("WakuOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = WakuOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the WAKUOASIS_* environment variables and try again.");
                return;
            }
