...
namespace NextGenSoftware.OASIS.API.Providers.CelestiaOASIS.TestHarness
{
    ...
    /// Configure with CELESTIAOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class CelestiaOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("CelestiaOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = CelestiaOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the CELESTIAOASIS_* environment variables and try again.");
                return;
            }
