...
NATS JetStream - high-throughput persistent pub/sub messaging.
...
```json
{
  "DefaultProviders": ["NATSJetStreamOASIS"]
}
```
...
- [NuGet](https://www.nuget.org/packages/NextGenSoftware.OASIS.API.Providers.NATSJetStreamOASIS/)
