...
Reservoir - NFT trading and data infrastructure protocol.
...
```json
{
  "DefaultProviders": ["ReservoirOASIS"]
}
```
...
- [NuGet](https://www.nuget.org/packages/NextGenSoftware.OASIS.API.Providers.ReservoirOASIS/)
