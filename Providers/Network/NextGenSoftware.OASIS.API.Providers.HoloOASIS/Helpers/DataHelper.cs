    ...
    public static class DataHelper
    {
        ...
        public static dynamic ConvertAvatarToParamsObject(IAvatar avatar)
        {
            return new
            {
                ...
                // Passwords and session credentials are deliberately excluded: Avatar is a public
                // Holochain DHT entry and HoloOASIS is a storage provider, not an authentication vault.
