...
namespace NextGenSoftware.OASIS.API.Providers.HEREMapsOASIS
{
    /// <summary>
    /// HERE Maps Enterprise Navigation OASIS Map Provider.
    /// Provides enterprise-grade routing, navigation, geocoding, and
    /// real-time traffic data via the HERE Maps REST APIs.
    /// </summary>
    public class HEREMapsOASIS : IOASISMapProvider
    {
        ...
        public HEREMapsOASIS()
        {
            MapProviderType = MapProviderType.HEREMaps;
            MapProviderName = "HEREMaps";
            MapProviderDescription = "HERE Maps Enterprise Navigation OASIS Map Provider";
        }
