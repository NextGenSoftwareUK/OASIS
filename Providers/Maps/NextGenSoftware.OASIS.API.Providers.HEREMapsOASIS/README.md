...
HERE Maps - enterprise mapping routing and location services.
...
```json
{
  "DefaultProviders": ["HEREMapsOASIS"]
}
```
...
- [NuGet](https://www.nuget.org/packages/NextGenSoftware.OASIS.API.Providers.HEREMapsOASIS/)
