...
namespace NextGenSoftware.OASIS.API.Providers.WRLD3DOASIS.TestHarness
{
    ...
    {
        private static WRLD3DOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== WRLD3DOASIS Test Harness ===");
            Console.WriteLine("Testing WRLD3DOASIS integration with OASIS...\n");
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "WRLD3DOASISTestUser",
                Email = "wrld3doasistest@example.com",
                FirstName = "WRLD3DOASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "WRLD3DOASISTestHolon",
                Description = "Test Holon for WRLD3DOASIS integration",
                CreatedDate = DateTime.UtcNow
            };
