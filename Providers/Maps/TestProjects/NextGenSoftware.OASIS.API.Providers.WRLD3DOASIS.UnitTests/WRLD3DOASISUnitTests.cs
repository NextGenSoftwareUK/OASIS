...
namespace NextGenSoftware.OASIS.API.Providers.WRLD3DOASIS.UnitTests
{
    ...
    public class WRLD3DOASISProviderTests
    {
        ...
        [TestMethod]
        public void ProviderType_ShouldBeWRLD3DOASIS()
        {
            // Arrange & Act
            var providerType = _provider.ProviderType;

            // Assert
            Assert.AreEqual(ProviderType.WRLD3DOASIS, providerType);
        }
        ...
        [TestMethod]
        public void ProviderName_ShouldBeWRLD3DOASIS()
        {
            // Arrange & Act
            var providerName = _provider.ProviderName;

            // Assert
            Assert.AreEqual("WRLD3DOASIS", providerName);
        }
