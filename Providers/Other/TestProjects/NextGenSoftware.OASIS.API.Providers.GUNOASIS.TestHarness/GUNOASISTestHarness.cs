...
namespace NextGenSoftware.OASIS.API.Providers.GUNOASIS.TestHarness
{
    ...
    /// Configure with GUNOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class GUNOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("GUNOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = GUNOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the GUNOASIS_* environment variables and try again.");
                return;
            }
