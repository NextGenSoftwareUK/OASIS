...
namespace NextGenSoftware.OASIS.API.Providers.UrbitOASIS.TestHarness
{
    ...
    /// Configure with URBITOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class UrbitOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("UrbitOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = UrbitOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the URBITOASIS_* environment variables and try again.");
                return;
            }
