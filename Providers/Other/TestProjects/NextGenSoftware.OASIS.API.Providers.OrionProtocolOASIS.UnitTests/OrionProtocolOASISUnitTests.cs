...
namespace NextGenSoftware.OASIS.API.Providers.OrionProtocolOASIS.UnitTests
{
    [TestClass]
    public class OrionProtocolOASISProviderTests
    {
        private OrionProtocolOASIS _provider;
        ...
        [TestMethod]
        public void ProviderType_ShouldBeOrionProtocolOASIS()
        {
            // Arrange & Act
            var providerType = _provider.ProviderType;

            // Assert
            Assert.AreEqual(ProviderType.OrionProtocolOASIS, providerType);
        }
        ...
        [TestMethod]
        public void ProviderName_ShouldBeOrionProtocolOASIS()
        {
            // Arrange & Act
            var providerName = _provider.ProviderName;

            // Assert
            Assert.AreEqual("OrionProtocolOASIS", providerName);
        }
