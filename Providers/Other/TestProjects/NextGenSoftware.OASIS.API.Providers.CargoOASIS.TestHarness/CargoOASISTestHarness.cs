...
{
    public class CargoOASISTestHarness
    {
        private static CargoOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== CargoOASIS Test Harness ===");
            Console.WriteLine("Testing CargoOASIS integration with OASIS...\n");
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "CargoOASISTestUser",
                Email = "cargooasistest@example.com",
                FirstName = "CargoOASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "CargoOASISTestHolon",
                Description = "Test Holon for CargoOASIS integration",
                CreatedDate = DateTime.UtcNow
            };
