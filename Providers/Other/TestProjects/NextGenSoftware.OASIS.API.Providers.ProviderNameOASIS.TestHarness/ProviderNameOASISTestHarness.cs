using NextGenSoftware.OASIS.API.Providers.ProviderNameOASIS;
...
namespace NextGenSoftware.OASIS.API.Providers.ProviderNameOASIS.TestHarness
{
    public class ProviderNameOASISTestHarness
    {
        private static ProviderNameOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== ProviderNameOASIS Test Harness ===");
            Console.WriteLine("Testing ProviderNameOASIS integration with OASIS...\n");

            _provider = new ProviderNameOASIS();
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "ProviderNameOASISTestUser",
                Email = "providernameoasistest@example.com",
                FirstName = "ProviderNameOASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "ProviderNameOASISTestHolon",
                Description = "Test Holon for ProviderNameOASIS integration",
                CreatedDate = DateTime.UtcNow
            };
