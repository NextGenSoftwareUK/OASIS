...
namespace NextGenSoftware.OASIS.API.Providers.ONION-Protocol.TestHarness
{
    public class ONION-ProtocolTestHarness
    {
        private static ONION-Protocol _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== ONION-Protocol Test Harness ===");
            Console.WriteLine("Testing ONION-Protocol integration with OASIS...\n");
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "ONION-ProtocolTestUser",
                Email = "onion-protocoltest@example.com",
                FirstName = "ONION-Protocol",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "ONION-ProtocolTestHolon",
                Description = "Test Holon for ONION-Protocol integration",
                CreatedDate = DateTime.UtcNow
            };
