...
namespace NextGenSoftware.OASIS.API.Providers.CloudflareOASIS.TestHarness
{
    ...
    /// Configure with CLOUDFLAREOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class CloudflareOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("CloudflareOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = CloudflareOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the CLOUDFLAREOASIS_* environment variables and try again.");
                return;
            }
