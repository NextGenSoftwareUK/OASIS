...
namespace NextGenSoftware.OASIS.API.Providers.ConvexOASIS.TestHarness
{
    ...
    /// Configure with CONVEXOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class ConvexOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("ConvexOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = ConvexOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the CONVEXOASIS_* environment variables and try again.");
                return;
            }
