...
namespace NextGenSoftware.OASIS.API.Providers.TursoOASIS.TestHarness
{
    ...
    /// Configure with TURSOOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class TursoOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("TursoOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = TursoOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the TURSOOASIS_* environment variables and try again.");
                return;
            }
