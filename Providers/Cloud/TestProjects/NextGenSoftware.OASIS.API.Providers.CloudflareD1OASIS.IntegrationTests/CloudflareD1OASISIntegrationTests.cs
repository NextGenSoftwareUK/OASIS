...
namespace NextGenSoftware.OASIS.API.Providers.CloudflareD1OASIS.IntegrationTests
{
    ...
    ///
    /// Connection details come from CLOUDFLARED1OASIS_&lt;PARAM&gt; environment variables. When the
    ...
    /// </summary>
    [TestClass]
    public class CloudflareD1OASISIntegrationTests
    {
        ...
        public void Setup()
        {
            _provider = CloudflareD1OASISTestFactory.Create();
        ...
        private void RequireLive()
        {
            if (!_live)
                Assert.Inconclusive(
                    "No live CloudflareD1OASIS backend configured - set the CLOUDFLARED1OASIS_* environment variables to run this.");
        }
