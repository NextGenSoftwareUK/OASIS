...
namespace NextGenSoftware.OASIS.API.Providers.AWSOASIS.TestHarness
{
    public class AWSOASISTestHarness
    {
        private static AWSOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== AWSOASIS Test Harness ===");
            Console.WriteLine("Testing AWSOASIS integration with OASIS...\n");
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "AWSOASISTestUser",
                Email = "awsoasistest@example.com",
                FirstName = "AWSOASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "AWSOASISTestHolon",
                Description = "Test Holon for AWSOASIS integration",
                CreatedDate = DateTime.UtcNow
            };
