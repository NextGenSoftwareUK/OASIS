...
namespace NextGenSoftware.OASIS.API.Providers.FirebaseOASIS.TestHarness
{
    ...
    /// Configure with FIREBASEOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class FirebaseOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("FirebaseOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = FirebaseOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the FIREBASEOASIS_* environment variables and try again.");
                return;
            }
