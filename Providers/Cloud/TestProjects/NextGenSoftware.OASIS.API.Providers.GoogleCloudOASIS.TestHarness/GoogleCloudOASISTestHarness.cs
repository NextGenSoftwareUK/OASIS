...
namespace NextGenSoftware.OASIS.API.Providers.GoogleCloudOASIS.TestHarness
{
    ...
    /// Configure with GOOGLECLOUDOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class GoogleCloudOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("GoogleCloudOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = GoogleCloudOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the GOOGLECLOUDOASIS_* environment variables and try again.");
                return;
            }
