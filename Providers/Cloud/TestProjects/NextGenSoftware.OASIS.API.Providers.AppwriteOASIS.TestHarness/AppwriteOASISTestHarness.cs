...
namespace NextGenSoftware.OASIS.API.Providers.AppwriteOASIS.TestHarness
{
    ...
    /// Configure with APPWRITEOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class AppwriteOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("AppwriteOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = AppwriteOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the APPWRITEOASIS_* environment variables and try again.");
                return;
            }
