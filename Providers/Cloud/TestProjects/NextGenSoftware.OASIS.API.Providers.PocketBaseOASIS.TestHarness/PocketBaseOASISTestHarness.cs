...
namespace NextGenSoftware.OASIS.API.Providers.PocketBaseOASIS.TestHarness
{
    ...
    /// Configure with POCKETBASEOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class PocketBaseOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("PocketBaseOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = PocketBaseOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the POCKETBASEOASIS_* environment variables and try again.");
                return;
            }
