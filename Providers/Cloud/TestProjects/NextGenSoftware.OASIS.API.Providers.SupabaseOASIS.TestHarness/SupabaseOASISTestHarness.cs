...
namespace NextGenSoftware.OASIS.API.Providers.SupabaseOASIS.TestHarness
{
    ...
    /// Configure with SUPABASEOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class SupabaseOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("SupabaseOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = SupabaseOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the SUPABASEOASIS_* environment variables and try again.");
                return;
            }
