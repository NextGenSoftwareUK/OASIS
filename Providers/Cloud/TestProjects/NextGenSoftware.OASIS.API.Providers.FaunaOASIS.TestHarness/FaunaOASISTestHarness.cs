...
namespace NextGenSoftware.OASIS.API.Providers.FaunaOASIS.TestHarness
{
    ...
    /// Configure with FAUNAOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class FaunaOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("FaunaOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = FaunaOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the FAUNAOASIS_* environment variables and try again.");
                return;
            }
