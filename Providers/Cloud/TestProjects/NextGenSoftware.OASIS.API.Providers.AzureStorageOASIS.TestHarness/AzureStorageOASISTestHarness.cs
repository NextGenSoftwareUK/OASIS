...
namespace NextGenSoftware.OASIS.API.Providers.AzureStorageOASIS.TestHarness
{
    ...
    /// Configure with AZURESTORAGEOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class AzureStorageOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("AzureStorageOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = AzureStorageOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the AZURESTORAGEOASIS_* environment variables and try again.");
                return;
            }
