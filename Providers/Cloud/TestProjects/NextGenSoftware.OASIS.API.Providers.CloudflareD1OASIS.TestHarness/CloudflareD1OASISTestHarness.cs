...
namespace NextGenSoftware.OASIS.API.Providers.CloudflareD1OASIS.TestHarness
{
    ...
    /// Configure with CLOUDFLARED1OASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class CloudflareD1OASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("CloudflareD1OASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = CloudflareD1OASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the CLOUDFLARED1OASIS_* environment variables and try again.");
                return;
            }
