...
namespace NextGenSoftware.OASIS.API.Providers.NeonOASIS.TestHarness
{
    ...
    /// Configure with NEONOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class NeonOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("NeonOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = NeonOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the NEONOASIS_* environment variables and try again.");
                return;
            }
