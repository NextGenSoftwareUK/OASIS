...
namespace NextGenSoftware.OASIS.API.Providers.UpstashOASIS.TestHarness
{
    public class UpstashOASISTestHarness
    {
        private static UpstashOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== UpstashOASIS Test Harness ===");
            string restUrl = Environment.GetEnvironmentVariable("UPSTASH_REST_URL") ?? "https://test.upstash.io";
            string token = Environment.GetEnvironmentVariable("UPSTASH_TOKEN") ?? "test-token";
            Console.WriteLine($"REST URL: {restUrl}\n");
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "UpstashOASISTestUser",
                Email = "upstashoasistest@example.com",
                FirstName = "Upstash",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "UpstashOASISTestHolon",
                Description = "Test Holon for UpstashOASIS",
                CreatedDate = DateTime.UtcNow
            };
