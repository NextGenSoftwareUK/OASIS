...
Bittensor - decentralised AI network with incentivised machine learning.
...
```json
{
  "DefaultProviders": ["BittensorOASIS"]
}
```
...
- [NuGet](https://www.nuget.org/packages/NextGenSoftware.OASIS.API.Providers.BittensorOASIS/)
