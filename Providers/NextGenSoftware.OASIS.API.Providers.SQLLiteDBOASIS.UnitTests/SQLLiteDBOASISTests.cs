...
{
    [TestClass]
    public class SQLLiteDBOASISTests
    {
        ...
        public async Task SaveAvatar_ShouldReturnNotSupported()
        {
            ...
            Assert.IsTrue(result.Message.Contains("not supported yet by SQLite provider"));
        }
        ...
        public void GetPlayersNearMe_ShouldReturnNotSupported()
        {
            ...
            // Assert
            Assert.IsFalse(result.IsSuccess);
            Assert.IsTrue(result.Message.Contains("not supported by SQLite provider"));
        }
        ...
        {
            // Assert
            Assert.AreEqual(ProviderType.SQLLiteDBOASIS, _provider.ProviderType);
        }
        ...
        {
            // Assert
            Assert.AreEqual("SQLLiteDBOASIS", _provider.ProviderName);
        }
    }
}
