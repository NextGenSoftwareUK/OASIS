...
Netlify Blobs - globally distributed key-value blob store.
...
```json
{
  "DefaultProviders": ["NetlifyBlobsOASIS"]
}
```
...
- [NuGet](https://www.nuget.org/packages/NextGenSoftware.OASIS.API.Providers.NetlifyBlobsOASIS/)
