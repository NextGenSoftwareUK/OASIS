...
namespace NextGenSoftware.OASIS.API.Providers.CouchDBOASIS.IntegrationTests
{
    [TestClass]
    public class CouchDBOASISIntegrationTests
    {
        private CouchDBOASIS _provider = null!;
        private static readonly string connStr = Environment.GetEnvironmentVariable("COUCHDB_URL") ?? "http://localhost:5984";
        ...
        {
            var avatar = new Avatar { Id = Guid.NewGuid(), Username = "couchdb-test-user", Email = "couchdb@test.com" };
        ...
        {
            var holon = new Holon { Id = Guid.NewGuid(), Name = "CouchDB Test Holon" };
