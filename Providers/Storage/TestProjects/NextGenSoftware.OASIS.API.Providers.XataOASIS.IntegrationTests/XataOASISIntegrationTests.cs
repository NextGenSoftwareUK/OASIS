...
namespace NextGenSoftware.OASIS.API.Providers.XataOASIS.IntegrationTests
{
    [TestClass]
    public class XataOASISIntegrationTests
    {
        private XataOASIS _provider = null!;
        private static readonly string connStr = Environment.GetEnvironmentVariable("XATA_URL") ?? "https://workspace.region.xata.sh/db/oasis:main";
        ...
        {
            var avatar = new Avatar { Id = Guid.NewGuid(), Username = "xata-test-user", Email = "xata@test.com" };
        ...
        {
            var holon = new Holon { Id = Guid.NewGuid(), Name = "Xata Test Holon" };
