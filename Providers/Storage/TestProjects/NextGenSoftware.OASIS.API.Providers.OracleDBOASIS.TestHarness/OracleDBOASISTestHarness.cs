...
namespace NextGenSoftware.OASIS.API.Providers.OracleDBOASIS.TestHarness
{
    ...
    /// Configure with ORACLEDBOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class OracleDBOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("OracleDBOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = OracleDBOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the ORACLEDBOASIS_* environment variables and try again.");
                return;
            }
