...
namespace NextGenSoftware.OASIS.API.Providers.MemcachedOASIS.IntegrationTests
{
    [TestClass]
    public class MemcachedOASISIntegrationTests
    {
        private MemcachedOASIS _provider = null!;
        private static readonly string connStr = Environment.GetEnvironmentVariable("MEMCACHED_HOST") ?? "localhost";
        ...
        {
            var avatar = new Avatar { Id = Guid.NewGuid(), Username = "memcached-test-user", Email = "memcached@test.com" };
        ...
        {
            var holon = new Holon { Id = Guid.NewGuid(), Name = "Memcached Test Holon" };
