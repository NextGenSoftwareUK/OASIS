...
namespace NextGenSoftware.OASIS.API.Providers.ArweaveOASIS.TestHarness
{
    ...
    /// Configure with ARWEAVEOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class ArweaveOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("ArweaveOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = ArweaveOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the ARWEAVEOASIS_* environment variables and try again.");
                return;
            }
