...
namespace NextGenSoftware.OASIS.API.Providers.PostgreSQLOASIS.TestHarness
{
    ...
    /// Configure with POSTGRESQLOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class PostgreSQLOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("PostgreSQLOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = PostgreSQLOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the POSTGRESQLOASIS_* environment variables and try again.");
                return;
            }
