...
namespace NextGenSoftware.OASIS.API.Providers.RavenDBOASIS.TestHarness
{
    ...
    /// Configure with RAVENDBOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class RavenDBOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("RavenDBOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = RavenDBOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the RAVENDBOASIS_* environment variables and try again.");
                return;
            }
