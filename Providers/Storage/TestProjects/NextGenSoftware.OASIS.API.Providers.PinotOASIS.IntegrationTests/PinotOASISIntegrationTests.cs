...
namespace NextGenSoftware.OASIS.API.Providers.PinotOASIS.IntegrationTests
{
    [TestClass]
    public class PinotOASISIntegrationTests
    {
        private PinotOASIS _provider = null!;
        private static readonly string connStr = Environment.GetEnvironmentVariable("PINOT_BROKER") ?? "http://localhost:8000";
        ...
        {
            var avatar = new Avatar { Id = Guid.NewGuid(), Username = "pinot-test-user", Email = "pinot@test.com" };
        ...
        {
            var holon = new Holon { Id = Guid.NewGuid(), Name = "Pinot Test Holon" };
