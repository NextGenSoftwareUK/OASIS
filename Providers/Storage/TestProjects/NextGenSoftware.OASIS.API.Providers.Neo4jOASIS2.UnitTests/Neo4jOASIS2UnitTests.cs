...
namespace NextGenSoftware.OASIS.API.Providers.Neo4jOASIS2.UnitTests
{
    [TestClass]
    public class Neo4jOASIS2ProviderTests
    {
        private Neo4jOASIS2 _provider;
        ...
        [TestMethod]
        public void ProviderType_ShouldBeNeo4jOASIS2()
        {
            // Arrange & Act
            var providerType = _provider.ProviderType;

            // Assert
            Assert.AreEqual(ProviderType.Neo4jOASIS2, providerType);
        }
        ...
        [TestMethod]
        public void ProviderName_ShouldBeNeo4jOASIS2()
        {
            // Arrange & Act
            var providerName = _provider.ProviderName;

            // Assert
            Assert.AreEqual("Neo4jOASIS2", providerName);
        }
