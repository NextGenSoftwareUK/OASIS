...
namespace NextGenSoftware.OASIS.API.Providers.MarqoOASIS.IntegrationTests
{
    [TestClass]
    public class MarqoOASISIntegrationTests
    {
        private MarqoOASIS _provider = null!;
        private static readonly string connStr = Environment.GetEnvironmentVariable("MARQO_URL") ?? "http://localhost:8882";
        ...
        {
            var avatar = new Avatar { Id = Guid.NewGuid(), Username = "marqo-test-user", Email = "marqo@test.com" };
        ...
        {
            var holon = new Holon { Id = Guid.NewGuid(), Name = "Marqo Test Holon" };
