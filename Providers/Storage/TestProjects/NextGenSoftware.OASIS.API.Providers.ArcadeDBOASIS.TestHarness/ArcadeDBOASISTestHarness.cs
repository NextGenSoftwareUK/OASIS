...
namespace NextGenSoftware.OASIS.API.Providers.ArcadeDBOASIS.TestHarness
{
    public class ArcadeDBOASISTestHarness
    {
        private static ArcadeDBOASIS _provider = null!;

        public static async Task Main(string[] args)
        {
            var connStr = Environment.GetEnvironmentVariable("ARCADEDB_URL") ?? "http://localhost:2480";
            Console.WriteLine($"ArcadeDBOASIS Test Harness - {connStr}");
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            var avatar = new Avatar { Id = Guid.NewGuid(), Username = "arcadedb-harness-user", Email = "arcadedb-harness@test.com" };
        ...
        private static async Task TestHolonOperations()
        {
            ...
            var holon = new Holon { Id = Guid.NewGuid(), Name = "ArcadeDB Harness Holon" };
