...
namespace NextGenSoftware.OASIS.API.Providers.DuckDBOASIS.TestHarness
{
    public class DuckDBOASISTestHarness
    {
        private static DuckDBOASIS _provider = null!;

        public static async Task Main(string[] args)
        {
            var connStr = Environment.GetEnvironmentVariable("DUCKDB_CONN") ?? "Data Source=oasis.duckdb";
            Console.WriteLine($"DuckDBOASIS Test Harness - {connStr}");
        ...
        {
            Console.WriteLine("\n--- Avatar Operations ---");
            var avatar = new Avatar { Id = Guid.NewGuid(), Username = "duckdb-harness", Email = "duckdb-harness@test.com" };
        ...
        {
            Console.WriteLine("\n--- Holon Operations ---");
            var holon = new Holon { Id = Guid.NewGuid(), Name = "DuckDB Harness Holon" };
