...
namespace NextGenSoftware.OASIS.API.Providers.ChromaOASIS.IntegrationTests
{
    [TestClass]
    public class ChromaOASISIntegrationTests
    {
        ...
        {
            var avatar = new Avatar { Id = Guid.NewGuid(), Username = "chroma-test-user", Email = "chroma@test.com" };
        ...
        {
            var holon = new Holon { Id = Guid.NewGuid(), Name = "Chroma Test Holon" };
