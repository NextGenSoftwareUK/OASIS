...
namespace NextGenSoftware.OASIS.API.Providers.SQLServerDBOASIS.TestHarness
{
    ...
    /// Configure with SQLSERVERDBOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class SQLServerDBOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("SQLServerDBOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = SQLServerDBOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the SQLSERVERDBOASIS_* environment variables and try again.");
                return;
            }
