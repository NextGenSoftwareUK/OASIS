...
namespace NextGenSoftware.OASIS.API.Providers.CassandraOASIS.TestHarness
{
    ...
    /// Configure with CASSANDRAOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class CassandraOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("CassandraOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = CassandraOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the CASSANDRAOASIS_* environment variables and try again.");
                return;
            }
