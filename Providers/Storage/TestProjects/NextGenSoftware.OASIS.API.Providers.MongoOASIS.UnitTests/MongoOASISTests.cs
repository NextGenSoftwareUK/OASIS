...
namespace NextGenSoftware.OASIS.API.Providers.MongoOASIS.UnitTests
{
    [TestClass]
    public class MongoOASISTests
    {
        ...
        public async Task SaveAvatar_ShouldReturnNotSupported()
        {
            ...
            Assert.IsTrue(result.Message.Contains("not supported yet by MongoDB provider"));
        }
        ...
        public void GetPlayersNearMe_ShouldReturnNotSupported()
        {
            ...
            // Assert
            Assert.IsFalse(result.IsSuccess);
            Assert.IsTrue(result.Message.Contains("not supported by MongoDB provider"));
        }
        ...
        [TestMethod]
        public void ProviderType_ShouldBeMongoOASIS()
        {
            // Assert
        ...
        [TestMethod]
        public void ProviderCategory_ShouldBeStorage()
        {
            // Assert
        ...
        [TestMethod]
        public void ProviderName_ShouldBeMongoOASIS()
        {
            // Assert
