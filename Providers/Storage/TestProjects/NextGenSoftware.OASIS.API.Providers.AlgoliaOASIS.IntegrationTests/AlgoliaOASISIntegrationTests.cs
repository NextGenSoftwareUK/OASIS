...
namespace NextGenSoftware.OASIS.API.Providers.AlgoliaOASIS.IntegrationTests
{
    [TestClass]
    public class AlgoliaOASISIntegrationTests
    {
        private AlgoliaOASIS _provider = null!;
        private static readonly string connStr = Environment.GetEnvironmentVariable("ALGOLIA_APP_ID") ?? "APPID";
        ...
        {
            var avatar = new Avatar { Id = Guid.NewGuid(), Username = "algolia-test-user", Email = "algolia@test.com" };
        ...
        {
            var holon = new Holon { Id = Guid.NewGuid(), Name = "Algolia Test Holon" };
