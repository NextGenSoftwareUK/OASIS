...
namespace NextGenSoftware.OASIS.API.Providers.LocalFileOASIS.UnitTests
{
    [TestClass]
    public class LocalFileOASISProviderTests
    {
        ...
        [TestMethod]
        public void ProviderType_ShouldBeLocalFileOASIS()
        {
            // Arrange & Act
            var providerType = _provider.ProviderType;

            // Assert
            Assert.AreEqual(ProviderType.LocalFileOASIS, providerType);
        }
        ...
        [TestMethod]
        public void ProviderName_ShouldBeLocalFileOASIS()
        {
            // Arrange & Act
            var providerName = _provider.ProviderName;

            // Assert
            Assert.AreEqual("LocalFileOASIS", providerName);
        }
