...
namespace NextGenSoftware.OASIS.API.Providers.LanceDBOASIS.IntegrationTests
{
    [TestClass]
    public class LanceDBOASISIntegrationTests
    {
        private LanceDBOASIS _provider = null!;
        private static readonly string connStr = Environment.GetEnvironmentVariable("LANCEDB_URL") ?? "https://db.lancedb.com";
        ...
        {
            var avatar = new Avatar { Id = Guid.NewGuid(), Username = "lancedb-test-user", Email = "lancedb@test.com" };
        ...
        {
            var holon = new Holon { Id = Guid.NewGuid(), Name = "LanceDB Test Holon" };
