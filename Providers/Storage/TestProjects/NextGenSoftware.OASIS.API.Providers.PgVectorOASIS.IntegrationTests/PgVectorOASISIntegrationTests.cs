...
namespace NextGenSoftware.OASIS.API.Providers.PgVectorOASIS.IntegrationTests
{
    [TestClass]
    public class PgVectorOASISIntegrationTests
    {
        private PgVectorOASIS _provider = null!;
        private static readonly string connStr = Environment.GetEnvironmentVariable("PGVECTOR_CONN") ?? "Host=localhost;Port=5432;Database=oasis;Username=postgres;Password=postgres";
        ...
        {
            var avatar = new Avatar { Id = Guid.NewGuid(), Username = "pgvector-test-user", Email = "pgvector@test.com" };
        ...
        {
            var holon = new Holon { Id = Guid.NewGuid(), Name = "PgVector Test Holon" };
