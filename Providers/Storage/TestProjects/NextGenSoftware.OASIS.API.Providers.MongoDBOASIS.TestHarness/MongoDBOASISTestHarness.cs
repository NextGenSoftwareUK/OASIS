...
namespace NextGenSoftware.OASIS.API.Providers.MongoDBOASIS.TestHarness
{
    public class MongoDBOASISTestHarness
    {
        private static MongoDBOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== MongoDBOASIS Test Harness ===");
            Console.WriteLine("Testing MongoDBOASIS integration with OASIS...\n");
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "MongoDBOASISTestUser",
                Email = "mongodboasistest@example.com",
                FirstName = "MongoDBOASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "MongoDBOASISTestHolon",
                Description = "Test Holon for MongoDBOASIS integration",
                CreatedDate = DateTime.UtcNow
            };
