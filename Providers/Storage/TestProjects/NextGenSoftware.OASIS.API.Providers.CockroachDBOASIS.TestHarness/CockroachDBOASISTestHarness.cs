...
namespace NextGenSoftware.OASIS.API.Providers.CockroachDBOASIS.TestHarness
{
    ...
    /// Configure with COCKROACHDBOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class CockroachDBOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("CockroachDBOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = CockroachDBOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the COCKROACHDBOASIS_* environment variables and try again.");
                return;
            }
