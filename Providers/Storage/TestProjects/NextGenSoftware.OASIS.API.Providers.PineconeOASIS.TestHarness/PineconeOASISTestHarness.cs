...
namespace NextGenSoftware.OASIS.API.Providers.PineconeOASIS.TestHarness
{
    public class PineconeOASISTestHarness
    {
        private static PineconeOASIS _provider = null!;

        public static async Task Main(string[] args)
        {
            var connStr = Environment.GetEnvironmentVariable("PINECONE_URL") ?? "https://oasis-storage-abc123.svc.us-east-1-aws.pinecone.io";
            Console.WriteLine($"PineconeOASIS Test Harness - {connStr}");
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            var avatar = new Avatar { Id = Guid.NewGuid(), Username = "pinecone-harness-user", Email = "pinecone-harness@test.com" };
        ...
        private static async Task TestHolonOperations()
        {
            ...
            var holon = new Holon { Id = Guid.NewGuid(), Name = "Pinecone Harness Holon" };
