...
namespace NextGenSoftware.OASIS.API.Providers.SurrealDBOASIS.TestHarness
{
    ...
    /// Configure with SURREALDBOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class SurrealDBOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("SurrealDBOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = SurrealDBOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the SURREALDBOASIS_* environment variables and try again.");
                return;
            }
