...
namespace NextGenSoftware.OASIS.API.Providers.CassandraOASIS.UnitTests
{
    /// <summary>
    ...
    /// </summary>
    [TestClass]
    public class CassandraOASISProviderTests
    {
        private CassandraOASIS _provider = null!;

        [TestInitialize]
        public void Setup() => _provider = CassandraOASISTestFactory.Create();
