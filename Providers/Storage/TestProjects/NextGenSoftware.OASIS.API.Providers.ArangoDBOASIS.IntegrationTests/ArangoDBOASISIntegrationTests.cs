...
namespace NextGenSoftware.OASIS.API.Providers.ArangoDBOASIS.IntegrationTests
{
    [TestClass]
    public class ArangoDBOASISIntegrationTests
    {
        private ArangoDBOASIS _provider = null!;
        private static readonly string connStr = Environment.GetEnvironmentVariable("ARANGODB_URL") ?? "http://localhost:8529";
        ...
        {
            var avatar = new Avatar { Id = Guid.NewGuid(), Username = "arangodb-test-user", Email = "arangodb@test.com" };
        ...
        {
            var holon = new Holon { Id = Guid.NewGuid(), Name = "ArangoDB Test Holon" };
