...
namespace NextGenSoftware.OASIS.API.Providers.LocalFileOASIS.TestHarness
{
    public class LocalFileOASISTestHarness
    {
        private static LocalFileOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== LocalFileOASIS Test Harness ===");
            Console.WriteLine("Testing LocalFileOASIS integration with OASIS...\n");
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "LocalFileOASISTestUser",
                Email = "localfileoasistest@example.com",
                FirstName = "LocalFileOASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "LocalFileOASISTestHolon",
                Description = "Test Holon for LocalFileOASIS integration",
                CreatedDate = DateTime.UtcNow
            };
