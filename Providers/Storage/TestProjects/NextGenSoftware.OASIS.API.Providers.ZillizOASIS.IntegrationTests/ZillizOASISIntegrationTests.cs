...
namespace NextGenSoftware.OASIS.API.Providers.ZillizOASIS.IntegrationTests
{
    [TestClass]
    public class ZillizOASISIntegrationTests
    {
        private ZillizOASIS _provider = null!;
        private static readonly string connStr = Environment.GetEnvironmentVariable("ZILLIZ_URL") ?? "https://in01-abc.aws-us-west-2.vectordb.zillizcloud.com";
        ...
        {
            var avatar = new Avatar { Id = Guid.NewGuid(), Username = "zilliz-test-user", Email = "zilliz@test.com" };
        ...
        {
            var holon = new Holon { Id = Guid.NewGuid(), Name = "Zilliz Test Holon" };
