...
namespace NextGenSoftware.OASIS.API.Providers.QuestDBOASIS.IntegrationTests
{
    [TestClass]
    public class QuestDBOASISIntegrationTests
    {
        private QuestDBOASIS _provider = null!;
        private static readonly string connStr = Environment.GetEnvironmentVariable("QUESTDB_CONN") ?? "Host=localhost;Port=8812;Username=admin;Password=quest;Database=qdb";
        ...
        {
            var avatar = new Avatar { Id = Guid.NewGuid(), Username = "questdb-test-user", Email = "questdb@test.com" };
        ...
        {
            var holon = new Holon { Id = Guid.NewGuid(), Name = "QuestDB Test Holon" };
