...
namespace NextGenSoftware.OASIS.API.Providers.BigQueryOASIS.TestHarness
{
    public class BigQueryOASISTestHarness
    {
        private static BigQueryOASIS _provider = null!;

        public static async Task Main(string[] args)
        {
            var connStr = Environment.GetEnvironmentVariable("BIGQUERY_PROJECT") ?? "my-project";
            Console.WriteLine($"BigQueryOASIS Test Harness - {connStr}");
        ...
        {
            Console.WriteLine("\n--- Avatar Operations ---");
            var avatar = new Avatar { Id = Guid.NewGuid(), Username = "bigquery-harness", Email = "bigquery-harness@test.com" };
        ...
        {
            Console.WriteLine("\n--- Holon Operations ---");
            var holon = new Holon { Id = Guid.NewGuid(), Name = "BigQuery Harness Holon" };
