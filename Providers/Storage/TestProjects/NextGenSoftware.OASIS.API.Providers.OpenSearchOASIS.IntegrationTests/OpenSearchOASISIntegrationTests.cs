...
namespace NextGenSoftware.OASIS.API.Providers.OpenSearchOASIS.IntegrationTests
{
    [TestClass]
    public class OpenSearchOASISIntegrationTests
    {
        private OpenSearchOASIS _provider = null!;
        private static readonly string connStr = Environment.GetEnvironmentVariable("OPENSEARCH_URL") ?? "http://localhost:9200";
        ...
        {
            var avatar = new Avatar { Id = Guid.NewGuid(), Username = "opensearch-test-user", Email = "opensearch@test.com" };
        ...
        {
            var holon = new Holon { Id = Guid.NewGuid(), Name = "OpenSearch Test Holon" };
