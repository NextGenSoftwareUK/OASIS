...
namespace NextGenSoftware.OASIS.API.Providers.PlanetScaleOASIS.TestHarness
{
    ...
    /// Configure with PLANETSCALEOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class PlanetScaleOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("PlanetScaleOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = PlanetScaleOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the PLANETSCALEOASIS_* environment variables and try again.");
                return;
            }
