...
namespace NextGenSoftware.OASIS.API.Providers.PgVectorOASIS
{
    /// <summary>
    /// OASIS provider for pgvector — PostgreSQL with the `vector` extension, turning any
    /// Postgres instance into a vector store.
    ///
    /// Tables: oasis_avatars, oasis_avatar_details, oasis_holons
    ///   id UUID PRIMARY KEY, doc JSONB, username TEXT, email TEXT,
    ///   parent_holon_id TEXT, embedding vector(1536) NULL
    ///
    /// The embedding column is provisioned so callers can attach real embeddings later;
    /// OASIS itself stores and retrieves the document via the JSONB `doc` column, with
    /// btree indexes on the lookup columns.
    /// </summary>
    public class PgVectorOASIS : OASISStorageProviderBase, IOASISDBStorageProvider
    {
        /// <summary>
        ...
        public PgVectorOASIS(string connectionString)
        {
        ...
        public override async Task<OASISResult<bool>> ActivateProviderAsync()
        {
            ...
            try
            {
                ...
                foreach (var table in new[] { CollAvatars, CollAvatarDetails, CollHolons })
                {
                    var ddl = $@"
                        ...
                        CREATE INDEX IF NOT EXISTS idx_{table}_parent ON {table}(parent_holon_id);";
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: ActivateProviderAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarAsync(Guid id, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: Avatar {id} not found.");
                else if (doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: Avatar {id} has been deleted.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: LoadAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarByUsernameAsync(string username, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null || doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: Avatar with username '{username}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: LoadAvatarByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarByEmailAsync(string email, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null || doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: Avatar with email '{email}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: LoadAvatarByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IAvatar>>> LoadAllAvatarsAsync(int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: LoadAllAvatarsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> SaveAvatarAsync(IAvatar avatar)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: SaveAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarAsync(Guid id, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: DeleteAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarByUsernameAsync(string username, bool softDelete = true)
        {
            ...
            try
            {
                ...
                if (avatar == null)
                    OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: Avatar '{username}' not found.");
                else
                    return await DeleteAvatarAsync(avatar.Id, softDelete);
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: DeleteAvatarByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarByEmailAsync(string email, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: DeleteAvatarByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailAsync(Guid id, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: AvatarDetail {id} not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: LoadAvatarDetailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailByUsernameAsync(string username, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: AvatarDetail '{username}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: LoadAvatarDetailByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailByEmailAsync(string email, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: AvatarDetail '{email}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: LoadAvatarDetailByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IAvatarDetail>>> LoadAllAvatarDetailsAsync(int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: LoadAllAvatarDetailsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> SaveAvatarDetailAsync(IAvatarDetail detail)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: SaveAvatarDetailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IHolon>> LoadHolonAsync(Guid id, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: Holon {id} not found.");
                else if (doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: Holon {id} has been deleted.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: LoadHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> LoadHolonsForParentAsync(Guid id, HolonType holonType = HolonType.All, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: LoadHolonsForParentAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> LoadAllHolonsAsync(HolonType holonType = HolonType.All, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: LoadAllHolonsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IHolon>> SaveHolonAsync(IHolon holon, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, bool saveChildrenOnProvider = false)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: SaveHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> SaveHolonsAsync(IEnumerable<IHolon> holons, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool saveChildrenOnProvider = false)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: SaveHolonsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public async Task<OASISResult<bool>> DeleteHolonSoftAsync(Guid id, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: DeleteHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        private async Task<T?> GetDocAsync<T>(string table, string id) where T : class
        {
            await using var conn = new NpgsqlConnection(_connectionString);
            await conn.OpenAsync();
            await using var cmd = new NpgsqlCommand($"SELECT doc FROM {table} WHERE id = @id LIMIT 1", conn);
        ...
        private async Task UpsertDocAsync<T>(string table, string id, T obj)
        {
            ...
            var sql = $@"
                INSERT INTO {table} (id, doc, username, email, parent_holon_id, updated_at)
                VALUES (@id, @doc::jsonb, @username, @email, @parent, NOW())
        ...
        private async Task<List<T>> ReadDocsAsync<T>(NpgsqlCommand cmd) where T : class
        {
            var list = new List<T>();
        ...
        private async Task<T?> FindOneAsync<T>(string table, string field, string value) where T : class
        {
            await using var conn = new NpgsqlConnection(_connectionString);
            await conn.OpenAsync();
            await using var cmd = new NpgsqlCommand($"SELECT doc FROM {table} WHERE {FieldColumn(field)} = @val LIMIT 1", conn);
            cmd.Parameters.AddWithValue("val", value);
            var list = await ReadDocsAsync<T>(cmd);
        ...
        private async Task<List<T>> FindAllAsync<T>(string table, string field, string value) where T : class
        {
            await using var conn = new NpgsqlConnection(_connectionString);
            await conn.OpenAsync();
            await using var cmd = new NpgsqlCommand($"SELECT doc FROM {table} WHERE {FieldColumn(field)} = @val LIMIT 1000", conn);
            cmd.Parameters.AddWithValue("val", value);
            return await ReadDocsAsync<T>(cmd);
        }
        ...
        private async Task<List<T>> GetAllDocsAsync<T>(string table) where T : class
        {
            await using var conn = new NpgsqlConnection(_connectionString);
            await conn.OpenAsync();
            await using var cmd = new NpgsqlCommand($"SELECT doc FROM {table} LIMIT 1000", conn);
            return await ReadDocsAsync<T>(cmd);
        }
        ...
        public override async Task<OASISResult<ISearchResults>> SearchAsync(ISearchParams searchParams, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PgVectorOASIS: SearchAsync failed: {ex.Message}");
            }
