...
namespace NextGenSoftware.OASIS.API.Providers.DatabricksOASIS
{
    /// <summary>
    /// OASIS provider for Databricks - the Delta Lake lakehouse.
    ///
    /// Drives a SQL warehouse through the Statement Execution API. Delta tables support
    /// MERGE, so avatar and holon writes are true upserts rather than append-and-dedupe.
    ///
    /// Tables: oasis_avatars, oasis_avatar_details, oasis_holons
    /// </summary>
    public class DatabricksOASIS : OASISStorageProviderBase, IOASISDBStorageProvider
    {
        /// <summary>
        ...
        public DatabricksOASIS(string workspaceUrl, string token, string warehouseId)
        {
        ...
        public override async Task<OASISResult<bool>> ActivateProviderAsync()
        {
            ...
            try
            {
                ...
                {
                    await ExecAsync($@"CREATE TABLE IF NOT EXISTS {table} (
                        id STRING, doc STRING, username STRING, email STRING,
                        parent_holon_id STRING, updated_at TIMESTAMP) USING DELTA");
                }
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: ActivateProviderAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarAsync(Guid id, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: Avatar {id} not found.");
                else if (doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: Avatar {id} has been deleted.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: LoadAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarByUsernameAsync(string username, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null || doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: Avatar with username '{username}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: LoadAvatarByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarByEmailAsync(string email, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null || doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: Avatar with email '{email}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: LoadAvatarByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IAvatar>>> LoadAllAvatarsAsync(int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: LoadAllAvatarsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> SaveAvatarAsync(IAvatar avatar)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: SaveAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarAsync(Guid id, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: DeleteAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarByUsernameAsync(string username, bool softDelete = true)
        {
            ...
            try
            {
                ...
                if (avatar == null)
                    OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: Avatar '{username}' not found.");
                else
                    return await DeleteAvatarAsync(avatar.Id, softDelete);
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: DeleteAvatarByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarByEmailAsync(string email, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: DeleteAvatarByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailAsync(Guid id, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: AvatarDetail {id} not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: LoadAvatarDetailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailByUsernameAsync(string username, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: AvatarDetail '{username}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: LoadAvatarDetailByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailByEmailAsync(string email, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: AvatarDetail '{email}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: LoadAvatarDetailByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IAvatarDetail>>> LoadAllAvatarDetailsAsync(int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: LoadAllAvatarDetailsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> SaveAvatarDetailAsync(IAvatarDetail detail)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: SaveAvatarDetailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IHolon>> LoadHolonAsync(Guid id, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: Holon {id} not found.");
                else if (doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: Holon {id} has been deleted.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: LoadHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> LoadHolonsForParentAsync(Guid id, HolonType holonType = HolonType.All, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: LoadHolonsForParentAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> LoadAllHolonsAsync(HolonType holonType = HolonType.All, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: LoadAllHolonsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IHolon>> SaveHolonAsync(IHolon holon, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, bool saveChildrenOnProvider = false)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: SaveHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> SaveHolonsAsync(IEnumerable<IHolon> holons, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool saveChildrenOnProvider = false)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: SaveHolonsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public async Task<OASISResult<bool>> DeleteHolonSoftAsync(Guid id, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: DeleteHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<ISearchResults>> SearchAsync(ISearchParams searchParams, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DatabricksOASIS: SearchAsync failed: {ex.Message}");
            }
        ...
        {
            var resp = await _http.PostAsync($"{_baseUrl}/api/2.0/sql/statements",
                Json(new { warehouse_id = _warehouseId, statement = sql, wait_timeout = "30s" }));
            ...
            if (!doc.RootElement.TryGetProperty("result", out var res)) return list;
            if (!res.TryGetProperty("data_array", out var rows) || rows.ValueKind != JsonValueKind.Array) return list;
        ...
        private async Task IngestAsync(string table, string id, string doc, string u, string e, string p)
            => await ExecAsync($@"MERGE INTO {table} t
        ...
        private async Task DeleteRowAsync(string table, string id)
            => await ExecAsync($"DELETE FROM {table} WHERE id = '{Esc(id)}'");
