...
namespace NextGenSoftware.OASIS.API.Providers.MarqoOASIS
{
    /// <summary>
    /// OASIS provider for Marqo — end-to-end multimodal tensor search engine.
    ///
    /// Indexes: oasis_avatars, oasis_avatar_details, oasis_holons
    /// Documents carry _id plus the serialised OASIS JSON in a `doc` field and mirrored
    /// lookup fields used by Marqo's `filter` expressions.
    ///
    /// Create:  POST   {base}/indexes/{index}
    /// Upsert:  POST   {base}/indexes/{index}/documents
    /// Get:     GET    {base}/indexes/{index}/documents/{id}
    /// Search:  POST   {base}/indexes/{index}/search   {{ q, filter, limit }}
    /// Delete:  POST   {base}/indexes/{index}/documents/delete-batch
    /// </summary>
    public class MarqoOASIS : OASISStorageProviderBase, IOASISDBStorageProvider
    {
        /// <summary>
        ...
        private const string CollAvatars = "oasis-avatars";
        private const string CollAvatarDetails = "oasis-avatar-details";
        private const string CollHolons = "oasis-holons";

        public MarqoOASIS(string baseUrl = "http://localhost:8882")
        {
            _baseUrl = baseUrl.TrimEnd('/');
            ProviderType = new EnumValue<ProviderType>(Core.Enums.ProviderType.MarqoOASIS);
        ...
        public override async Task<OASISResult<bool>> ActivateProviderAsync()
        {
            ...
            try
            {
                foreach (var idx in new[] { CollAvatars, CollAvatarDetails, CollHolons })
                    await EnsureIndexAsync(idx);
                IsProviderActivated = true;
                result.Result = true;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: ActivateProviderAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarAsync(Guid id, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: Avatar {id} not found.");
                else if (doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: Avatar {id} has been deleted.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: LoadAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarByUsernameAsync(string username, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null || doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: Avatar with username '{username}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: LoadAvatarByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarByEmailAsync(string email, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null || doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: Avatar with email '{email}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: LoadAvatarByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IAvatar>>> LoadAllAvatarsAsync(int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: LoadAllAvatarsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> SaveAvatarAsync(IAvatar avatar)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: SaveAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarAsync(Guid id, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: DeleteAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarByUsernameAsync(string username, bool softDelete = true)
        {
            ...
            try
            {
                ...
                if (avatar == null)
                    OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: Avatar '{username}' not found.");
                else
                    return await DeleteAvatarAsync(avatar.Id, softDelete);
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: DeleteAvatarByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarByEmailAsync(string email, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: DeleteAvatarByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailAsync(Guid id, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: AvatarDetail {id} not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: LoadAvatarDetailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailByUsernameAsync(string username, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: AvatarDetail '{username}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: LoadAvatarDetailByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailByEmailAsync(string email, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: AvatarDetail '{email}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: LoadAvatarDetailByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IAvatarDetail>>> LoadAllAvatarDetailsAsync(int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: LoadAllAvatarDetailsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> SaveAvatarDetailAsync(IAvatarDetail detail)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: SaveAvatarDetailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IHolon>> LoadHolonAsync(Guid id, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: Holon {id} not found.");
                else if (doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: Holon {id} has been deleted.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: LoadHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> LoadHolonsForParentAsync(Guid id, HolonType holonType = HolonType.All, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: LoadHolonsForParentAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> LoadAllHolonsAsync(HolonType holonType = HolonType.All, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: LoadAllHolonsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IHolon>> SaveHolonAsync(IHolon holon, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, bool saveChildrenOnProvider = false)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: SaveHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> SaveHolonsAsync(IEnumerable<IHolon> holons, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool saveChildrenOnProvider = false)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: SaveHolonsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public async Task<OASISResult<bool>> DeleteHolonSoftAsync(Guid id, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: DeleteHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        {
            // 409/400 when it already exists — both are acceptable.
            await _http.PostAsync($"{_baseUrl}/indexes/{index}",
                Json(new { type = "unstructured", model = "hf/e5-base-v2" }));
        }

        private static Dictionary<string, object> ToDoc<T>(T obj, string id)
        {
            var json = JsonSerializer.Serialize(obj);
            var d = new Dictionary<string, object> { { "_id", id }, { "doc", json } };
            using var parsed = JsonDocument.Parse(json);
            foreach (var field in new[] { "Username", "Email", "ParentHolonId" })
            {
                if (parsed.RootElement.TryGetProperty(field, out var el) && el.ValueKind == JsonValueKind.String)
                {
                    var v = el.GetString();
                    if (!string.IsNullOrEmpty(v)) d[field] = v;
                }
            }
            return d;
        }

        private static T? DocFrom<T>(JsonElement el) where T : class
        {
            if (!el.TryGetProperty("doc", out var docEl)) return null;
        ...
        private async Task<T?> GetDocAsync<T>(string index, string id) where T : class
        {
            var resp = await _http.GetAsync($"{_baseUrl}/indexes/{index}/documents/{Uri.EscapeDataString(id)}");
            if (!resp.IsSuccessStatusCode) return null;
            var json = await resp.Content.ReadAsStringAsync();
            using var doc = JsonDocument.Parse(json);
            return DocFrom<T>(doc.RootElement);
        }

        private async Task UpsertDocAsync<T>(string index, string id, T obj)
        {
            var resp = await _http.PostAsync($"{_baseUrl}/indexes/{index}/documents",
                Json(new { documents = new[] { ToDoc(obj, id) }, tensorFields = Array.Empty<string>() }));
            resp.EnsureSuccessStatusCode();
        }

        private async Task DeleteDocAsync(string index, string id)
        {
            var resp = await _http.PostAsync($"{_baseUrl}/indexes/{index}/documents/delete-batch",
                Json(new[] { id }));
            if (resp.StatusCode != System.Net.HttpStatusCode.NotFound)
                resp.EnsureSuccessStatusCode();
        }

        private async Task<List<T>> SearchAsync<T>(string index, string? filter, int limit) where T : class
        {
            object body = filter == null
                ? new { q = "*", limit, searchMethod = "LEXICAL" }
                : (object)new { q = "*", filter, limit, searchMethod = "LEXICAL" };

            var resp = await _http.PostAsync($"{_baseUrl}/indexes/{index}/search", Json(body));
            ...
            {
                var item = DocFrom<T>(h);
                if (item != null) list.Add(item);
            }
            return list;
        }

        private async Task<T?> FindOneAsync<T>(string index, string field, string value) where T : class
        {
            var results = await SearchAsync<T>(index, $"{field}:({value})", 1);
            return results.Count > 0 ? results[0] : null;
        }

        private async Task<List<T>> FindAllAsync<T>(string index, string field, string value) where T : class
            => await SearchAsync<T>(index, $"{field}:({value})", 1000);

        private async Task<List<T>> GetAllDocsAsync<T>(string index) where T : class
            => await SearchAsync<T>(index, null, 1000);
        ...
        public override async Task<OASISResult<ISearchResults>> SearchAsync(ISearchParams searchParams, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MarqoOASIS: SearchAsync failed: {ex.Message}");
            }
