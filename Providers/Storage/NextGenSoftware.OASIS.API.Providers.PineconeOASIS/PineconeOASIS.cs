...
namespace NextGenSoftware.OASIS.API.Providers.PineconeOASIS
{
    /// <summary>
    /// OASIS provider for Pinecone — managed vector database.
    ///
    /// OASIS uses Pinecone as a metadata-addressable document store: each Avatar/Holon
    /// is upserted as a 1-dimension placeholder vector whose metadata carries the full
    /// serialised JSON plus indexed lookup fields (Username, Email, ParentHolonId).
    /// Namespaces separate the three OASIS collections.
    ///
    /// Upsert:  POST {host}/vectors/upsert   {{ vectors:[{{id, values, metadata}}], namespace }}
    /// Fetch:   GET  {host}/vectors/fetch?ids={{id}}&namespace={{ns}}
    /// Query:   POST {host}/query            {{ vector, topK, filter, includeMetadata, namespace }}
    /// Delete:  POST {host}/vectors/delete   {{ ids, namespace }}
    /// Auth:    Api-Key header
    /// </summary>
    public class PineconeOASIS : OASISStorageProviderBase, IOASISDBStorageProvider
    {
        /// <summary>
        ...
        private const string CollAvatars = "avatars";
        private const string CollAvatarDetails = "avatar-details";
        private const string CollHolons = "holons";

        public PineconeOASIS(string indexHost, string apiKey)
        {
        ...
        public override async Task<OASISResult<bool>> ActivateProviderAsync()
        {
            ...
            try
            {
                var resp = await _http.GetAsync($"{_host}/describe_index_stats");
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: ActivateProviderAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarAsync(Guid id, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: Avatar {id} not found.");
                else if (doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: Avatar {id} has been deleted.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: LoadAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarByUsernameAsync(string username, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null || doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: Avatar with username '{username}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: LoadAvatarByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarByEmailAsync(string email, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null || doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: Avatar with email '{email}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: LoadAvatarByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IAvatar>>> LoadAllAvatarsAsync(int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: LoadAllAvatarsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> SaveAvatarAsync(IAvatar avatar)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: SaveAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarAsync(Guid id, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: DeleteAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarByUsernameAsync(string username, bool softDelete = true)
        {
            ...
            try
            {
                ...
                if (avatar == null)
                    OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: Avatar '{username}' not found.");
                else
                    return await DeleteAvatarAsync(avatar.Id, softDelete);
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: DeleteAvatarByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarByEmailAsync(string email, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: DeleteAvatarByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailAsync(Guid id, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: AvatarDetail {id} not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: LoadAvatarDetailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailByUsernameAsync(string username, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: AvatarDetail '{username}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: LoadAvatarDetailByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailByEmailAsync(string email, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: AvatarDetail '{email}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: LoadAvatarDetailByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IAvatarDetail>>> LoadAllAvatarDetailsAsync(int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: LoadAllAvatarDetailsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> SaveAvatarDetailAsync(IAvatarDetail detail)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: SaveAvatarDetailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IHolon>> LoadHolonAsync(Guid id, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: Holon {id} not found.");
                else if (doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: Holon {id} has been deleted.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: LoadHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> LoadHolonsForParentAsync(Guid id, HolonType holonType = HolonType.All, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: LoadHolonsForParentAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> LoadAllHolonsAsync(HolonType holonType = HolonType.All, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: LoadAllHolonsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IHolon>> SaveHolonAsync(IHolon holon, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, bool saveChildrenOnProvider = false)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: SaveHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> SaveHolonsAsync(IEnumerable<IHolon> holons, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool saveChildrenOnProvider = false)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: SaveHolonsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public async Task<OASISResult<bool>> DeleteHolonSoftAsync(Guid id, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: DeleteHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        private static Dictionary<string, object> ToMetadata<T>(T obj, string id)
        {
            var json = JsonSerializer.Serialize(obj);
            var meta = new Dictionary<string, object> { { "id", id }, { "_doc", json } };
            ...
            foreach (var field in new[] { "Username", "Email", "ParentHolonId" })
            {
                ...
                {
                    var v = el.GetString();
                    if (!string.IsNullOrEmpty(v)) meta[field] = v;
                }
            }
            return meta;
        }

        private static T? FromMetadata<T>(JsonElement meta) where T : class
        {
            if (!meta.TryGetProperty("_doc", out var docEl)) return null;
            var raw = docEl.GetString();
            return string.IsNullOrEmpty(raw) ? null : JsonSerializer.Deserialize<T>(raw, new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
        }

        private async Task<T?> GetDocAsync<T>(string ns, string id) where T : class
        {
            var resp = await _http.GetAsync($"{_host}/vectors/fetch?ids={Uri.EscapeDataString(id)}&namespace={ns}");
            if (!resp.IsSuccessStatusCode) return null;
            var json = await resp.Content.ReadAsStringAsync();
            using var doc = JsonDocument.Parse(json);
            if (!doc.RootElement.TryGetProperty("vectors", out var vectors)) return null;
            if (!vectors.TryGetProperty(id, out var vec)) return null;
            if (!vec.TryGetProperty("metadata", out var meta)) return null;
            return FromMetadata<T>(meta);
        }

        private async Task UpsertDocAsync<T>(string ns, string id, T obj)
        {
            var body = new
            {
                vectors = new[] { new { id, values = new[] { 0.0f }, metadata = ToMetadata(obj, id) } },
                @namespace = ns
            };
            var resp = await _http.PostAsync($"{_host}/vectors/upsert", Json(body));
            resp.EnsureSuccessStatusCode();
        }

        private async Task DeleteDocAsync(string ns, string id)
        {
            var resp = await _http.PostAsync($"{_host}/vectors/delete",
                Json(new { ids = new[] { id }, @namespace = ns }));
            if (resp.StatusCode != System.Net.HttpStatusCode.NotFound)
                resp.EnsureSuccessStatusCode();
        }

        private async Task<List<T>> QueryAsync<T>(string ns, object? filter, int topK) where T : class
        {
            object body = filter == null
                ? new { vector = new[] { 0.0f }, topK, includeMetadata = true, @namespace = ns }
                : (object)new { vector = new[] { 0.0f }, topK, filter, includeMetadata = true, @namespace = ns };

            var resp = await _http.PostAsync($"{_host}/query", Json(body));
            resp.EnsureSuccessStatusCode();
            var json = await resp.Content.ReadAsStringAsync();
            using var doc = JsonDocument.Parse(json);
            var list = new List<T>();
            if (!doc.RootElement.TryGetProperty("matches", out var matches)) return list;
            foreach (var m in matches.EnumerateArray())
            {
                if (!m.TryGetProperty("metadata", out var meta)) continue;
                var item = FromMetadata<T>(meta);
                if (item != null) list.Add(item);
            }
            return list;
        }

        private async Task<T?> FindOneAsync<T>(string ns, string field, string value) where T : class
        {
            var results = await QueryAsync<T>(ns, new Dictionary<string, object> { { field, new Dictionary<string, object> { { "$eq", value } } } }, 1);
            return results.Count > 0 ? results[0] : null;
        }

        private async Task<List<T>> FindAllAsync<T>(string ns, string field, string value) where T : class
            => await QueryAsync<T>(ns, new Dictionary<string, object> { { field, new Dictionary<string, object> { { "$eq", value } } } }, 1000);

        private async Task<List<T>> GetAllDocsAsync<T>(string ns) where T : class
            => await QueryAsync<T>(ns, null, 1000);
        ...
        public override async Task<OASISResult<ISearchResults>> SearchAsync(ISearchParams searchParams, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"PineconeOASIS: SearchAsync failed: {ex.Message}");
            }
