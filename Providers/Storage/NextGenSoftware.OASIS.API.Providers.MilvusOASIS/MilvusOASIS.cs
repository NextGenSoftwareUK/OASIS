...
namespace NextGenSoftware.OASIS.API.Providers.MilvusOASIS
{
    /// <summary>
    /// OASIS provider for Milvus — vector database via Milvus REST API v2.
    ///
    /// Milvus is the leading open-source vector database, self-hosted or via Milvus Lite.
    ///
    /// Collections: oasis_avatars, oasis_avatar_details, oasis_holons
    /// Each row: id (VARCHAR pk), doc (VARCHAR JSON blob), username, email,
    /// parent_holon_id, plus a 1-dim placeholder vector.
    ///
    /// Create:  POST {base}/v2/vectordb/collections/create
    /// Upsert:  POST {base}/v2/vectordb/entities/upsert
    /// Get:     POST {base}/v2/vectordb/entities/get     { collectionName, id }
    /// Query:   POST {base}/v2/vectordb/entities/query   { collectionName, filter }
    /// Delete:  POST {base}/v2/vectordb/entities/delete  { collectionName, filter }
    /// Auth:    Authorization: Bearer {token}
    /// </summary>
    public class MilvusOASIS : OASISStorageProviderBase, IOASISDBStorageProvider
    {
        /// <summary>
        ...
        public MilvusOASIS(string baseUrl = "http://localhost:19530", string? token = null)
        {
            _baseUrl = baseUrl.TrimEnd('/');
            ProviderType = new EnumValue<ProviderType>(Core.Enums.ProviderType.MilvusOASIS);
        ...
        public override async Task<OASISResult<bool>> ActivateProviderAsync()
        {
            ...
            try
            {
                foreach (var c in new[] { CollAvatars, CollAvatarDetails, CollHolons })
                    await EnsureCollectionAsync(c);
                IsProviderActivated = true;
                result.Result = true;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: ActivateProviderAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarAsync(Guid id, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: Avatar {id} not found.");
                else if (doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: Avatar {id} has been deleted.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: LoadAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarByUsernameAsync(string username, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null || doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: Avatar with username '{username}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: LoadAvatarByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarByEmailAsync(string email, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null || doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: Avatar with email '{email}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: LoadAvatarByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IAvatar>>> LoadAllAvatarsAsync(int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: LoadAllAvatarsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> SaveAvatarAsync(IAvatar avatar)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: SaveAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarAsync(Guid id, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: DeleteAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarByUsernameAsync(string username, bool softDelete = true)
        {
            ...
            try
            {
                ...
                if (avatar == null)
                    OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: Avatar '{username}' not found.");
                else
                    return await DeleteAvatarAsync(avatar.Id, softDelete);
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: DeleteAvatarByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarByEmailAsync(string email, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: DeleteAvatarByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailAsync(Guid id, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: AvatarDetail {id} not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: LoadAvatarDetailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailByUsernameAsync(string username, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: AvatarDetail '{username}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: LoadAvatarDetailByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailByEmailAsync(string email, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: AvatarDetail '{email}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: LoadAvatarDetailByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IAvatarDetail>>> LoadAllAvatarDetailsAsync(int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: LoadAllAvatarDetailsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> SaveAvatarDetailAsync(IAvatarDetail detail)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: SaveAvatarDetailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IHolon>> LoadHolonAsync(Guid id, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: Holon {id} not found.");
                else if (doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: Holon {id} has been deleted.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: LoadHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> LoadHolonsForParentAsync(Guid id, HolonType holonType = HolonType.All, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: LoadHolonsForParentAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> LoadAllHolonsAsync(HolonType holonType = HolonType.All, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: LoadAllHolonsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IHolon>> SaveHolonAsync(IHolon holon, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, bool saveChildrenOnProvider = false)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: SaveHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> SaveHolonsAsync(IEnumerable<IHolon> holons, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool saveChildrenOnProvider = false)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: SaveHolonsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public async Task<OASISResult<bool>> DeleteHolonSoftAsync(Guid id, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: DeleteHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        private async Task EnsureCollectionAsync(string collection)
        {
            var body = new
            {
                ...
                schema = new
                {
                    ...
                    fields = new object[]
                    {
                        new { fieldName = "id", dataType = "VarChar", isPrimary = true, elementTypeParams = new { max_length = 64 } },
                        new { fieldName = "doc", dataType = "VarChar", elementTypeParams = new { max_length = 65535 } },
                        new { fieldName = "username", dataType = "VarChar", elementTypeParams = new { max_length = 512 } },
                        new { fieldName = "email", dataType = "VarChar", elementTypeParams = new { max_length = 512 } },
                        new { fieldName = "parent_holon_id", dataType = "VarChar", elementTypeParams = new { max_length = 64 } },
                        new { fieldName = "vector", dataType = "FloatVector", elementTypeParams = new { dim = 1 } }
                    }
                },
                indexParams = new object[]
                {
                    new { fieldName = "vector", indexName = "vector_idx", metricType = "L2", indexType = "FLAT" }
                }
            };
            // Already-exists is not an error — Milvus returns a non-zero code we ignore.
            await _http.PostAsync($"{_baseUrl}/v2/vectordb/collections/create", Json(body));
        }
        ...
        private static List<T> ParseData<T>(JsonElement root) where T : class
        {
            var list = new List<T>();
        ...
        {
            var resp = await _http.PostAsync($"{_baseUrl}/v2/vectordb/entities/get",
                Json(new { collectionName = collection, id = new[] { id }, outputFields = new[] { "doc" } }));
            if (!resp.IsSuccessStatusCode) return null;
            var json = await resp.Content.ReadAsStringAsync();
            using var doc = JsonDocument.Parse(json);
            var list = ParseData<T>(doc.RootElement);
            return list.Count > 0 ? list[0] : null;
        }

        private async Task UpsertDocAsync<T>(string collection, string id, T obj)
        {
            var resp = await _http.PostAsync($"{_baseUrl}/v2/vectordb/entities/upsert",
                Json(new { collectionName = collection, data = new[] { ToRow(obj, id) } }));
            resp.EnsureSuccessStatusCode();
        }

        private async Task DeleteDocAsync(string collection, string id)
        {
            var resp = await _http.PostAsync($"{_baseUrl}/v2/vectordb/entities/delete",
                Json(new { collectionName = collection, filter = $"id == \"{id}\"" }));
            if (resp.StatusCode != System.Net.HttpStatusCode.NotFound)
                resp.EnsureSuccessStatusCode();
        }

        private async Task<List<T>> QueryAsync<T>(string collection, string filter, int limit) where T : class
        {
            var resp = await _http.PostAsync($"{_baseUrl}/v2/vectordb/entities/query",
                Json(new { collectionName = collection, filter, outputFields = new[] { "doc" }, limit }));
            if (!resp.IsSuccessStatusCode) return new List<T>();
            var json = await resp.Content.ReadAsStringAsync();
            using var doc = JsonDocument.Parse(json);
            return ParseData<T>(doc.RootElement);
        }

        private async Task<T?> FindOneAsync<T>(string collection, string field, string value) where T : class
        {
            var results = await QueryAsync<T>(collection, $"{FieldColumn(field)} == \"{value}\"", 1);
            return results.Count > 0 ? results[0] : null;
        }

        private async Task<List<T>> FindAllAsync<T>(string collection, string field, string value) where T : class
            => await QueryAsync<T>(collection, $"{FieldColumn(field)} == \"{value}\"", 1000);

        private async Task<List<T>> GetAllDocsAsync<T>(string collection) where T : class
            => await QueryAsync<T>(collection, "id != \"\"", 1000);
        ...
        public override async Task<OASISResult<ISearchResults>> SearchAsync(ISearchParams searchParams, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"MilvusOASIS: SearchAsync failed: {ex.Message}");
            }
