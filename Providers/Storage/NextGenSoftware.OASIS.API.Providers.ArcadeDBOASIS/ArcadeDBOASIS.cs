...
namespace NextGenSoftware.OASIS.API.Providers.ArcadeDBOASIS
{
    /// <summary>
    /// OASIS provider for ArcadeDB — multi-model database (graph + document + key-value +
    /// time series) and spiritual successor to OrientDB.
    ///
    /// Database: oasis   Document types: Avatar, AvatarDetail, Holon
    ///
    /// ArcadeDB speaks SQL, Cypher, Gremlin, GraphQL and the MongoDB wire protocol; this
    /// provider uses its SQL dialect over the HTTP API, which gives OASIS graph-native
    /// storage for holon parent/child relationships.
    ///
    /// Query:   POST {base}/api/v1/query/{db}    {{ language:"sql", command:"SELECT ..." }}
    /// Command: POST {base}/api/v1/command/{db}  {{ language:"sql", command:"UPDATE ..." }}
    /// Auth:    HTTP Basic
    /// </summary>
    public class ArcadeDBOASIS : OASISStorageProviderBase, IOASISDBStorageProvider
    {
        /// <summary>
        ...
        private const string Database = "oasis";

        private const string CollAvatars = "Avatar";
        private const string CollAvatarDetails = "AvatarDetail";
        private const string CollHolons = "Holon";

        public ArcadeDBOASIS(string baseUrl = "http://localhost:2480", string username = "root", string password = "playwithdata")
        {
        ...
        public override async Task<OASISResult<bool>> ActivateProviderAsync()
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: ActivateProviderAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarAsync(Guid id, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: Avatar {id} not found.");
                else if (doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: Avatar {id} has been deleted.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: LoadAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarByUsernameAsync(string username, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null || doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: Avatar with username '{username}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: LoadAvatarByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarByEmailAsync(string email, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null || doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: Avatar with email '{email}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: LoadAvatarByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IAvatar>>> LoadAllAvatarsAsync(int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: LoadAllAvatarsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> SaveAvatarAsync(IAvatar avatar)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: SaveAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarAsync(Guid id, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: DeleteAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarByUsernameAsync(string username, bool softDelete = true)
        {
            ...
            try
            {
                ...
                if (avatar == null)
                    OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: Avatar '{username}' not found.");
                else
                    return await DeleteAvatarAsync(avatar.Id, softDelete);
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: DeleteAvatarByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarByEmailAsync(string email, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: DeleteAvatarByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailAsync(Guid id, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: AvatarDetail {id} not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: LoadAvatarDetailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailByUsernameAsync(string username, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: AvatarDetail '{username}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: LoadAvatarDetailByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailByEmailAsync(string email, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: AvatarDetail '{email}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: LoadAvatarDetailByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IAvatarDetail>>> LoadAllAvatarDetailsAsync(int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: LoadAllAvatarDetailsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> SaveAvatarDetailAsync(IAvatarDetail detail)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: SaveAvatarDetailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IHolon>> LoadHolonAsync(Guid id, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: Holon {id} not found.");
                else if (doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: Holon {id} has been deleted.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: LoadHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> LoadHolonsForParentAsync(Guid id, HolonType holonType = HolonType.All, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: LoadHolonsForParentAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> LoadAllHolonsAsync(HolonType holonType = HolonType.All, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: LoadAllHolonsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IHolon>> SaveHolonAsync(IHolon holon, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, bool saveChildrenOnProvider = false)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: SaveHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> SaveHolonsAsync(IEnumerable<IHolon> holons, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool saveChildrenOnProvider = false)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: SaveHolonsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public async Task<OASISResult<bool>> DeleteHolonSoftAsync(Guid id, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: DeleteHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        {
            var resp = await _http.PostAsync($"{_baseUrl}/api/v1/query/{Database}",
                Json(new { language = "sql", command = sql }));
            ...
            var list = new List<T>();
            if (!doc.RootElement.TryGetProperty("result", out var rows) || rows.ValueKind != JsonValueKind.Array)
                return list;
        ...
        private static string FieldColumn(string field) => field switch
        {
            ...
            _ => char.ToLowerInvariant(field[0]) + field.Substring(1)
        };

        private async Task<T?> GetDocAsync<T>(string type, string id) where T : class
        {
            var results = await QueryAsync<T>($"SELECT doc FROM {type} WHERE oasisId = '{Esc(id)}' LIMIT 1");
            return results.Count > 0 ? results[0] : null;
        }

        private async Task UpsertDocAsync<T>(string type, string id, T obj)
        {
            var json = JsonSerializer.Serialize(obj);
            string username = "", email = "", parent = "";
            using (var d = JsonDocument.Parse(json))
            {
                if (d.RootElement.TryGetProperty("Username", out var u) && u.ValueKind == JsonValueKind.String) username = u.GetString() ?? "";
                if (d.RootElement.TryGetProperty("Email", out var e) && e.ValueKind == JsonValueKind.String) email = e.GetString() ?? "";
                if (d.RootElement.TryGetProperty("ParentHolonId", out var p) && p.ValueKind == JsonValueKind.String) parent = p.GetString() ?? "";
            }
        ...
        {
            var results = await QueryAsync<T>($"SELECT doc FROM {type} WHERE {FieldColumn(field)} = '{Esc(value)}' LIMIT 1");
            return results.Count > 0 ? results[0] : null;
        }

        private async Task<List<T>> FindAllAsync<T>(string type, string field, string value) where T : class
            => await QueryAsync<T>($"SELECT doc FROM {type} WHERE {FieldColumn(field)} = '{Esc(value)}' LIMIT 1000");

        private async Task<List<T>> GetAllDocsAsync<T>(string type) where T : class
            => await QueryAsync<T>($"SELECT doc FROM {type} LIMIT 1000");
        ...
        public override async Task<OASISResult<ISearchResults>> SearchAsync(ISearchParams searchParams, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"ArcadeDBOASIS: SearchAsync failed: {ex.Message}");
            }
