...
namespace NextGenSoftware.OASIS.API.Providers.DruidOASIS
{
    /// <summary>
    /// OASIS provider for Apache Druid - real-time OLAP.
    ///
    /// Druid is append-only: it ingests events and has no point-update path. A save
    /// therefore appends a row stamped with updated_at, and every read takes the most
    /// recent row per id (ORDER BY updated_at DESC LIMIT 1). A soft delete appends a row
    /// whose document carries the deleted flag, so history is preserved rather than
    /// overwritten - the natural grain for this engine.
    ///
    /// Datasources: oasis_avatars, oasis_avatar_details, oasis_holons
    /// </summary>
    public class DruidOASIS : OASISStorageProviderBase, IOASISDBStorageProvider
    {
        /// <summary>
        ...
        public DruidOASIS(string baseUrl = "http://localhost:8888")
        {
            _baseUrl = baseUrl.TrimEnd('/');
            ProviderType = new EnumValue<ProviderType>(Core.Enums.ProviderType.DruidOASIS);
        ...
        public override async Task<OASISResult<bool>> ActivateProviderAsync()
        {
            ...
            try
            {
                // Druid creates datasources on first ingest; just verify the broker answers.
                var resp = await _http.PostAsync($"{_baseUrl}/druid/v2/sql",
                    Json(new { query = "SELECT 1" }));
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: ActivateProviderAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarAsync(Guid id, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"DruidOASIS: Avatar {id} not found.");
                else if (doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"DruidOASIS: Avatar {id} has been deleted.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: LoadAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarByUsernameAsync(string username, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null || doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"DruidOASIS: Avatar with username '{username}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: LoadAvatarByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> LoadAvatarByEmailAsync(string email, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null || doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"DruidOASIS: Avatar with email '{email}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: LoadAvatarByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IAvatar>>> LoadAllAvatarsAsync(int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: LoadAllAvatarsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatar>> SaveAvatarAsync(IAvatar avatar)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: SaveAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarAsync(Guid id, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: DeleteAvatarAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarByUsernameAsync(string username, bool softDelete = true)
        {
            ...
            try
            {
                ...
                if (avatar == null)
                    OASISErrorHandling.HandleError(ref result, $"DruidOASIS: Avatar '{username}' not found.");
                else
                    return await DeleteAvatarAsync(avatar.Id, softDelete);
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: DeleteAvatarByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<bool>> DeleteAvatarByEmailAsync(string email, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: DeleteAvatarByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailAsync(Guid id, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"DruidOASIS: AvatarDetail {id} not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: LoadAvatarDetailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailByUsernameAsync(string username, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"DruidOASIS: AvatarDetail '{username}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: LoadAvatarDetailByUsernameAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailByEmailAsync(string email, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"DruidOASIS: AvatarDetail '{email}' not found.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: LoadAvatarDetailByEmailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IAvatarDetail>>> LoadAllAvatarDetailsAsync(int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: LoadAllAvatarDetailsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> SaveAvatarDetailAsync(IAvatarDetail detail)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: SaveAvatarDetailAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IHolon>> LoadHolonAsync(Guid id, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            try
            {
                ...
                if (doc == null)
                    OASISErrorHandling.HandleError(ref result, $"DruidOASIS: Holon {id} not found.");
                else if (doc.IsDeleted)
                    OASISErrorHandling.HandleError(ref result, $"DruidOASIS: Holon {id} has been deleted.");
                else
                    result.Result = doc;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: LoadHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> LoadHolonsForParentAsync(Guid id, HolonType holonType = HolonType.All, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: LoadHolonsForParentAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> LoadAllHolonsAsync(HolonType holonType = HolonType.All, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool loadChildrenFromProvider = false, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: LoadAllHolonsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IHolon>> SaveHolonAsync(IHolon holon, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, bool saveChildrenOnProvider = false)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: SaveHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<IEnumerable<IHolon>>> SaveHolonsAsync(IEnumerable<IHolon> holons, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, int curentChildDepth = 0, bool continueOnError = true, bool saveChildrenOnProvider = false)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: SaveHolonsAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public async Task<OASISResult<bool>> DeleteHolonSoftAsync(Guid id, bool softDelete = true)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: DeleteHolonAsync failed: {ex.Message}");
            }
            return result;
        }
        ...
        public override async Task<OASISResult<ISearchResults>> SearchAsync(ISearchParams searchParams, bool loadChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true, int version = 0)
        {
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"DruidOASIS: SearchAsync failed: {ex.Message}");
            }
        ...
        {
            var resp = await _http.PostAsync($"{_baseUrl}/druid/v2/sql", Json(new { query = sql }));
        ...
        {
            // Druid ingests through a task spec; every save appends a row and reads take
            // the most recent one per id.
            var spec = new
            {
                type = "index_parallel",
                spec = new
                {
                    ...
                    {
                        dataSource = table,
                        timestampSpec = new { column = "updated_at", format = "auto" },
                        dimensionsSpec = new { dimensions = new[] { "id", "doc", "username", "email", "parent_holon_id" } }
                    },
                    ioConfig = new
                    {
                        type = "index_parallel",
            ...
            var resp = await _http.PostAsync($"{_baseUrl}/druid/indexer/v1/task", Json(spec));
            resp.EnsureSuccessStatusCode();
        }

        private async Task DeleteRowAsync(string table, string id)
        {
            // Append-only engine: record the deletion as a new row rather than erasing history.
