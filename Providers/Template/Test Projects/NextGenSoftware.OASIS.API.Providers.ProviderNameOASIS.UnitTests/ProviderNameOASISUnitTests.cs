...
namespace NextGenSoftware.OASIS.API.Providers.ProviderNameOASIS.UnitTests
{
    [TestClass]
    public class ProviderNameOASISProviderTests
    {
        private ProviderNameOASIS _provider;
        ...
        [TestMethod]
        public void ProviderType_ShouldBeProviderNameOASIS()
        {
            // Arrange & Act
            var providerType = _provider.ProviderType;

            // Assert
            Assert.AreEqual(ProviderType.ProviderNameOASIS, providerType);
        }
        ...
        [TestMethod]
        public void ProviderName_ShouldBeProviderNameOASIS()
        {
            // Arrange & Act
            var providerName = _provider.ProviderName;

            // Assert
            Assert.AreEqual("ProviderNameOASIS", providerName);
        }
