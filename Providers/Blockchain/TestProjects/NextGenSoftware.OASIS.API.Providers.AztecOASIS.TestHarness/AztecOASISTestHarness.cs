...
namespace NextGenSoftware.OASIS.API.Providers.AztecOASIS.TestHarness
{
    ...
    /// Configure with AZTECOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class AztecOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("AztecOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = AztecOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the AZTECOASIS_* environment variables and try again.");
                return;
            }
