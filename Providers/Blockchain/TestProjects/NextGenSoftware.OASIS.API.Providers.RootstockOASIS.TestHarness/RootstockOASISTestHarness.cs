...
namespace NextGenSoftware.OASIS.API.Providers.RootstockOASIS.TestHarness
{
    public class RootstockOASISTestHarness
    {
        private static RootstockOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== RootstockOASIS Test Harness ===");
            Console.WriteLine("Testing RootstockOASIS integration with OASIS...\n");
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "RootstockOASISTestUser",
                Email = "rootstockoasistest@example.com",
                FirstName = "RootstockOASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "RootstockOASISTestHolon",
                Description = "Test Holon for RootstockOASIS integration",
                CreatedDate = DateTime.UtcNow
            };
