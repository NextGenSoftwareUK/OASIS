...
namespace NextGenSoftware.OASIS.API.Providers.CeramicOASIS.TestHarness
{
    ...
    /// Configure with CERAMICOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class CeramicOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("CeramicOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = CeramicOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the CERAMICOASIS_* environment variables and try again.");
                return;
            }
