...
namespace NextGenSoftware.OASIS.API.Providers.OptimismOASIS.UnitTests
{
    [TestClass]
    public class OptimismOASISProviderTests
    {
        private OptimismOASIS _provider;
        ...
        [TestMethod]
        public void ProviderType_ShouldBeOptimismOASIS()
        {
            // Arrange & Act
            var providerType = _provider.ProviderType;

            // Assert
            Assert.AreEqual(ProviderType.OptimismOASIS, providerType);
        }
        ...
        [TestMethod]
        public void ProviderName_ShouldBeOptimismOASIS()
        {
            // Arrange & Act
            var providerName = _provider.ProviderName;

            // Assert
            Assert.AreEqual("OptimismOASIS", providerName);
        }
