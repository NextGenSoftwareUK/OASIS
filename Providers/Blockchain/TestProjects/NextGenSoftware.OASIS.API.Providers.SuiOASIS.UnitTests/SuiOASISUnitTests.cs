...
{
    [TestClass]
    public class SuiOASISProviderTests
    {
        private SuiOASIS _provider;
        ...
        [TestMethod]
        public void ProviderType_ShouldBeSuiOASIS()
        {
            // Arrange & Act
        ...
        [TestMethod]
        public void ProviderName_ShouldBeSuiOASIS()
        {
            // Arrange & Act
            var providerName = _provider.ProviderName;

            // Assert
            Assert.AreEqual("SuiOASIS", providerName);
        }
