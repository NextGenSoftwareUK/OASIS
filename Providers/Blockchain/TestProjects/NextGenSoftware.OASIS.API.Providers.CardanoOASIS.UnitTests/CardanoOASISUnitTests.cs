...
namespace NextGenSoftware.OASIS.API.Providers.CardanoOASIS.UnitTests
{
    [TestClass]
    public class CardanoOASISProviderTests
    {
        private CardanoOASIS _provider;
        ...
        [TestMethod]
        public void ProviderType_ShouldBeCardanoOASIS()
        {
            // Arrange & Act
            var providerType = _provider.ProviderType;

            // Assert
            Assert.AreEqual(ProviderType.CardanoOASIS, providerType);
        }
        ...
        [TestMethod]
        public void ProviderName_ShouldBeCardanoOASIS()
        {
            // Arrange & Act
            var providerName = _provider.ProviderName;

            // Assert
            Assert.AreEqual("CardanoOASIS", providerName);
        }
