...
namespace NextGenSoftware.OASIS.API.Providers.NEAROASIS.TestHarness
{
    public class NEAROASISTestHarness
    {
        private static NEAROASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== NEAROASIS Test Harness ===");
            Console.WriteLine("Testing NEAROASIS integration with OASIS...\n");
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "NEAROASISTestUser",
                Email = "nearoasistest@example.com",
                FirstName = "NEAROASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "NEAROASISTestHolon",
                Description = "Test Holon for NEAROASIS integration",
                CreatedDate = DateTime.UtcNow
            };
