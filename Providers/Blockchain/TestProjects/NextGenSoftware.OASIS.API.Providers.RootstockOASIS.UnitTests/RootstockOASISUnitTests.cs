...
namespace NextGenSoftware.OASIS.API.Providers.RootstockOASIS.UnitTests
{
    [TestClass]
    public class RootstockOASISProviderTests
    {
        ...
        [TestMethod]
        public void ProviderType_ShouldBeRootstockOASIS()
        {
            // Arrange & Act
            var providerType = _provider.ProviderType;

            // Assert
            Assert.AreEqual(ProviderType.RootstockOASIS, providerType);
        }
        ...
        [TestMethod]
        public void ProviderName_ShouldBeRootstockOASIS()
        {
            // Arrange & Act
            var providerName = _provider.ProviderName;

            // Assert
            Assert.AreEqual("RootstockOASIS", providerName);
        }
