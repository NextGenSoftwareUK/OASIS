...
namespace NextGenSoftware.OASIS.API.Providers.CardanoOASIS.TestHarness
{
    public class CardanoOASISTestHarness
    {
        private static CardanoOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== CardanoOASIS Test Harness ===");
            Console.WriteLine("Testing CardanoOASIS integration with OASIS...\n");

            _provider = new CardanoOASIS();
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "CardanoOASISTestUser",
                Email = "cardanooasistest@example.com",
                FirstName = "CardanoOASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "CardanoOASISTestHolon",
                Description = "Test Holon for CardanoOASIS integration",
                CreatedDate = DateTime.UtcNow
            };
