...
namespace NextGenSoftware.OASIS.API.Providers.ArbitrumOASIS.IntegrationTests
{
    ...
    public class ArbitrumOASISIntegrationTests
    {
        ...
        public void Setup()
        {
            _provider = new ArbitrumOASIS("https://arb1.arbitrum.io/rpc", "pk", 421614, "0xContract");
        }
        ...
        public async Task FullProviderLifecycle_ShouldWork()
        {
            ...
            Assert.IsTrue(saveAvatarResult.Message.Contains("not supported yet by Arbitrum provider"));
            ...
            Assert.IsTrue(loadAvatarResult.Message.Contains("not supported yet by Arbitrum provider"));
            ...
            Assert.IsTrue(saveHolonResult.Message.Contains("not supported yet by Arbitrum provider"));
            ...
            Assert.IsTrue(loadHolonResult.Message.Contains("not supported yet by Arbitrum provider"));
            ...
            Assert.IsTrue(mintResult.Message.Contains("not supported yet by Arbitrum provider"));
            ...
            Assert.IsTrue(loadNFTResult.Message.Contains("not supported yet by Arbitrum provider"));
            ...
            Assert.IsTrue(sendTransactionResult.Message.Contains("not supported yet by Arbitrum provider"));
            ...
            Assert.IsTrue(placeGeoNFTResult.Message.Contains("not supported yet by Arbitrum provider"));
            ...
            Assert.IsTrue(loadGeoNFTsResult.Message.Contains("not supported yet by Arbitrum provider"));
            ...
            Assert.IsTrue(searchResult.Message.Contains("not supported yet by Arbitrum provider"));
            ...
            Assert.IsTrue(importResult.Message.Contains("not supported yet by Arbitrum provider"));

            var exportResult = await _provider.ExportAllAsync();
            Assert.IsTrue(exportResult.IsError, "ExportAll should return not supported");
            Assert.IsTrue(exportResult.Message.Contains("not supported yet by Arbitrum provider"));
        ...
        public async Task ErrorHandling_ShouldBeConsistent()
        {
            ...
            Assert.IsTrue(sendNFTResult.Message.Contains("not supported yet by Arbitrum provider"));
        }
