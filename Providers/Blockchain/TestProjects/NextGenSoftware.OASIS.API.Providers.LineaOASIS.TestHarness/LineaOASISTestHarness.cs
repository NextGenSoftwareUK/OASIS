...
namespace NextGenSoftware.OASIS.API.Providers.LineaOASIS.TestHarness
{
    public class LineaOASISTestHarness
    {
        private static LineaOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== LineaOASIS Test Harness ===");
            Console.WriteLine("Testing LineaOASIS integration with OASIS...\n");
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "LineaOASISTestUser",
                Email = "lineaoasistest@example.com",
                FirstName = "LineaOASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "LineaOASISTestHolon",
                Description = "Test Holon for LineaOASIS integration",
                CreatedDate = DateTime.UtcNow
            };
