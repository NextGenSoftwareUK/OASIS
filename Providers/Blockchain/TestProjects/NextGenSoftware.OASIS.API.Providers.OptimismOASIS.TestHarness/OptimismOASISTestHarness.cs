...
namespace NextGenSoftware.OASIS.API.Providers.OptimismOASIS.TestHarness
{
    public class OptimismOASISTestHarness
    {
        private static OptimismOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== OptimismOASIS Test Harness ===");
            Console.WriteLine("Testing OptimismOASIS integration with OASIS...\n");

            _provider = new OptimismOASIS();
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "OptimismOASISTestUser",
                Email = "optimismoasistest@example.com",
                FirstName = "OptimismOASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "OptimismOASISTestHolon",
                Description = "Test Holon for OptimismOASIS integration",
                CreatedDate = DateTime.UtcNow
            };
