...
namespace NextGenSoftware.OASIS.API.Providers.HashgraphOASIS.TestHarness
{
    public class HashgraphOASISTestHarness
    {
        private static HashgraphOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== HashgraphOASIS Test Harness ===");
            Console.WriteLine("Testing HashgraphOASIS integration with OASIS...\n");

            _provider = new HashgraphOASIS();
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "HashgraphOASISTestUser",
                Email = "hashgraphoasistest@example.com",
                FirstName = "HashgraphOASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "HashgraphOASISTestHolon",
                Description = "Test Holon for HashgraphOASIS integration",
                CreatedDate = DateTime.UtcNow
            };
