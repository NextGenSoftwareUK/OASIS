...
namespace NextGenSoftware.OASIS.API.Providers.PolkadotOASIS.UnitTests
{
    [TestClass]
    public class PolkadotOASISProviderTests
    {
        ...
        [TestMethod]
        public void ProviderType_ShouldBePolkadotOASIS()
        {
            // Arrange & Act
        ...
        [TestMethod]
        public void ProviderName_ShouldBePolkadotOASIS()
        {
            // Arrange & Act
            var providerName = _provider.ProviderName;

            // Assert
            Assert.AreEqual("PolkadotOASIS", providerName);
        }
