...
namespace NextGenSoftware.OASIS.API.Providers.PolygonOASIS.TestHarness
{
    public class PolygonOASISTestHarness
    {
        private static PolygonOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== PolygonOASIS Test Harness ===");
            Console.WriteLine("Testing PolygonOASIS integration with OASIS...\n");
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "PolygonOASISTestUser",
                Email = "polygonoasistest@example.com",
                FirstName = "PolygonOASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "PolygonOASISTestHolon",
                Description = "Test Holon for PolygonOASIS integration",
                CreatedDate = DateTime.UtcNow
            };
