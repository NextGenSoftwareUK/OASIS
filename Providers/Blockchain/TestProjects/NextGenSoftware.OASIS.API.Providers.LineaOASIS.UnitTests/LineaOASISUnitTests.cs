...
namespace NextGenSoftware.OASIS.API.Providers.LineaOASIS.UnitTests
{
    [TestClass]
    public class LineaOASISProviderTests
    {
        ...
        [TestMethod]
        public void ProviderType_ShouldBeLineaOASIS()
        {
            var providerType = _provider.ProviderType;
            Assert.AreEqual(ProviderType.LineaOASIS, providerType);
        }
        ...
        [TestMethod]
        public void ProviderName_ShouldBeLineaOASIS()
        {
            Assert.AreEqual("LineaOASIS", _provider.ProviderName);
        }
