...
namespace NextGenSoftware.OASIS.API.Providers.BasechainOASIS.TestHarness
{
    ...
    /// Configure with BASECHAINOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class BasechainOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("BasechainOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = BasechainOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the BASECHAINOASIS_* environment variables and try again.");
                return;
            }
