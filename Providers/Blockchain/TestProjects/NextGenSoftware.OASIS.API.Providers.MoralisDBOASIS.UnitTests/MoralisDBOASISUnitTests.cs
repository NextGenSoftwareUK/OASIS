...
namespace NextGenSoftware.OASIS.API.Providers.MoralisDBOASIS.UnitTests
{
    [TestClass]
    public class MoralisDBOASISProviderTests
    {
        private MoralisDBOASIS _provider;
        ...
        [TestMethod]
        public void ProviderType_ShouldBeMoralisDBOASIS()
        {
            // Arrange & Act
            var providerType = _provider.ProviderType;

            // Assert
            Assert.AreEqual(ProviderType.MoralisDBOASIS, providerType);
        }
        ...
        [TestMethod]
        public void ProviderName_ShouldBeMoralisDBOASIS()
        {
            // Arrange & Act
            var providerName = _provider.ProviderName;

            // Assert
            Assert.AreEqual("MoralisDBOASIS", providerName);
        }
