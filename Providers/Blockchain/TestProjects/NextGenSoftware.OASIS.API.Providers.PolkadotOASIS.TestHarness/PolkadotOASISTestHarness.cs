...
{
    public class PolkadotOASISTestHarness
    {
        private static PolkadotOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== PolkadotOASIS Test Harness ===");
            Console.WriteLine("Testing PolkadotOASIS integration with OASIS...\n");
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "PolkadotOASISTestUser",
                Email = "polkadotoasistest@example.com",
                FirstName = "PolkadotOASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "PolkadotOASISTestHolon",
                Description = "Test Holon for PolkadotOASIS integration",
                CreatedDate = DateTime.UtcNow
            };
