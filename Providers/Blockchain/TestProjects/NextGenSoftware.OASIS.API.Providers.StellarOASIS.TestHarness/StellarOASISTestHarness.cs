...
namespace NextGenSoftware.OASIS.API.Providers.StellarOASIS.TestHarness
{
    ...
    /// Configure with STELLAROASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class StellarOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("StellarOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = StellarOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the STELLAROASIS_* environment variables and try again.");
                return;
            }
