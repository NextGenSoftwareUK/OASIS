...
namespace NextGenSoftware.OASIS.API.Providers.ZkSyncOASIS.UnitTests
{
    [TestClass]
    public class ZkSyncOASISProviderTests
    {
        private ZkSyncOASIS _provider;
        ...
        [TestMethod]
        public void ProviderType_ShouldBeZkSyncOASIS()
        {
            // Arrange & Act
            var providerType = _provider.ProviderType;

            // Assert
            Assert.AreEqual(ProviderType.ZkSyncOASIS, providerType);
        }
        ...
        [TestMethod]
        public void ProviderName_ShouldBeZkSyncOASIS()
        {
            // Arrange & Act
            var providerName = _provider.ProviderName;

            // Assert
            Assert.AreEqual("ZkSyncOASIS", providerName);
        }
