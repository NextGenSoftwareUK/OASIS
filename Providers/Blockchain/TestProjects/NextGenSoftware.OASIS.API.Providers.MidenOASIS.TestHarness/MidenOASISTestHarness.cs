...
namespace NextGenSoftware.OASIS.API.Providers.MidenOASIS.TestHarness
{
    ...
    /// Configure with MIDENOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class MidenOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("MidenOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = MidenOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the MIDENOASIS_* environment variables and try again.");
                return;
            }
