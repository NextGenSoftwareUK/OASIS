...
namespace NextGenSoftware.OASIS.API.Providers.AlgorandOASIS.TestHarness
{
    ...
    /// Configure with ALGORANDOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class AlgorandOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("AlgorandOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = AlgorandOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the ALGORANDOASIS_* environment variables and try again.");
                return;
            }
