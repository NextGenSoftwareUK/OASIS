...
namespace NextGenSoftware.OASIS.API.Providers.SuiOASIS.TestHarness
{
    public class SuiOASISTestHarness
    {
        private static SuiOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== SuiOASIS Test Harness ===");
            Console.WriteLine("Testing SuiOASIS integration with OASIS...\n");
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "SuiOASISTestUser",
                Email = "suioasistest@example.com",
                FirstName = "SuiOASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "SuiOASISTestHolon",
                Description = "Test Holon for SuiOASIS integration",
                CreatedDate = DateTime.UtcNow
            };
