...
namespace NextGenSoftware.OASIS.API.Providers.CosmosBlockChainOASIS.TestHarness
{
    public class CosmosBlockChainOASISTestHarness
    {
        private static CosmosBlockChainOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== CosmosBlockChainOASIS Test Harness ===");
            Console.WriteLine("Testing CosmosBlockChainOASIS integration with OASIS...\n");
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "CosmosBlockChainOASISTestUser",
                Email = "cosmosblockchainoasistest@example.com",
                FirstName = "CosmosBlockChainOASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "CosmosBlockChainOASISTestHolon",
                Description = "Test Holon for CosmosBlockChainOASIS integration",
                CreatedDate = DateTime.UtcNow
            };
