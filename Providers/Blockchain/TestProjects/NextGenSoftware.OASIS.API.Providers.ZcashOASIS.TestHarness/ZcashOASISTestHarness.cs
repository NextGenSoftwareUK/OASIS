...
namespace NextGenSoftware.OASIS.API.Providers.ZcashOASIS.TestHarness
{
    ...
    /// Configure with ZCASHOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class ZcashOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("ZcashOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = ZcashOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the ZCASHOASIS_* environment variables and try again.");
                return;
            }
