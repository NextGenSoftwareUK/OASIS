...
namespace NextGenSoftware.OASIS.API.Providers.FilecoinOASIS.TestHarness
{
    ...
    /// Configure with FILECOINOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class FilecoinOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("FilecoinOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = FilecoinOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the FILECOINOASIS_* environment variables and try again.");
                return;
            }
