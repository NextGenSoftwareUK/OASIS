...
namespace NextGenSoftware.OASIS.API.Providers.ZkSyncOASIS.TestHarness
{
    public class ZkSyncOASISTestHarness
    {
        private static ZkSyncOASIS _provider;

        public static async Task Main(string[] args)
        {
            Console.WriteLine("=== ZkSyncOASIS Test Harness ===");
            Console.WriteLine("Testing ZkSyncOASIS integration with OASIS...\n");

            _provider = new ZkSyncOASIS();
        ...
        private static async Task TestAvatarOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Username = "ZkSyncOASISTestUser",
                Email = "zksyncoasistest@example.com",
                FirstName = "ZkSyncOASIS",
                LastName = "Tester",
        ...
        private static async Task TestHolonOperations()
        {
            ...
            {
                Id = Guid.NewGuid(),
                Name = "ZkSyncOASISTestHolon",
                Description = "Test Holon for ZkSyncOASIS integration",
                CreatedDate = DateTime.UtcNow
            };
