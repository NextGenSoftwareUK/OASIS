...
namespace NextGenSoftware.OASIS.API.Providers.FantomOASIS.IntegrationTests
{
    /// <summary>
    /// Integration tests for Fantom OASIS Provider
    /// These tests require actual Fantom network connectivity and should be run in a test environment.
    /// </summary>
    public class FantomOASISIntegrationTests : IClassFixture<FantomOASISIntegrationTestFixture>
    {
        private readonly FantomOASIS _provider;
        private readonly FantomOASISIntegrationTestFixture _fixture;

        public FantomOASISIntegrationTests(FantomOASISIntegrationTestFixture fixture)
        {
            _fixture = fixture;
        ...
        public async Task SaveAvatar_ShouldSucceed()
        {
            ...
            {
                Username = "testuser_fantom_integration",
        ...
        public async Task SaveHolon_ShouldSucceed()
        {
            ...
            var holon = new Holon
            {
                Name = "Test Holon Fantom Integration",
                Description = "A test holon for Fantom integration testing",
        ...
        public async Task LoadHolon_ShouldSucceed()
        {
            ...
            var holon = new Holon
            {
                Name = "Test Holon Fantom Load",
                Description = "A test holon for Fantom loading testing",
                HolonType = HolonType.Generic
            };
        ...
        public async Task SearchAvatars_ShouldReturnResults()
        {
            ...
            var avatar = new Avatar
            {
                Username = "testuser_fantom_search",
                Email = "test@example.com",
                FirstName = "Test",
                LastName = "User"
            };
            ...
            // Act
            var result = await _provider.SearchAvatarsAsync("testuser_fantom_search");
        ...
        public async Task SearchHolons_ShouldReturnResults()
        {
            ...
            var holon = new Holon
            {
                Name = "Test Holon Fantom Search",
                Description = "A test holon for Fantom search testing",
                HolonType = HolonType.Generic
            };
            var saveResult = await _provider.SaveHolonAsync(holon);
            Assert.False(saveResult.IsError);
            ...
            // Act
            var result = await _provider.SearchHolonsAsync("Test Holon Fantom Search");
        ...
        public async Task GetAccountBalance_ShouldHandleInvalidAddress()
        {
            ...
            // The exact behavior depends on the Fantom network response
            Assert.NotNull(result);
        }
    }

    /// <summary>
    /// Test fixture for Fantom integration tests
    /// </summary>
    public class FantomOASISIntegrationTestFixture : IDisposable
    {
        public FantomOASISIntegrationTestFixture()
        {
