...
namespace NextGenSoftware.OASIS.API.Providers.StarknetOASIS.TestHarness
{
    ...
    /// Configure with STARKNETOASIS_&lt;PARAM&gt; environment variables.
    /// </summary>
    public static class StarknetOASISTestHarness
    {
        public static async Task Main()
        {
            Console.WriteLine("StarknetOASIS Test Harness");
            Console.WriteLine(new string('-', 60));

            var provider = StarknetOASISTestFactory.Create();
            ...
            {
                Console.WriteLine($"\nSet the STARKNETOASIS_* environment variables and try again.");
                return;
            }
