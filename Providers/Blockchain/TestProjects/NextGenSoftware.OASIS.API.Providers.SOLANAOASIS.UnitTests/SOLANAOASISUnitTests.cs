...
namespace NextGenSoftware.OASIS.API.Providers.SOLANAOASIS.UnitTests
{
    [TestClass]
    public class SOLANAOASISProviderTests
    {
        ...
        [TestMethod]
        public void ProviderType_ShouldBeSOLANAOASIS()
        {
            // Arrange & Act
        ...
        [TestMethod]
        public void ProviderName_ShouldBeSOLANAOASIS()
        {
            // Arrange & Act
