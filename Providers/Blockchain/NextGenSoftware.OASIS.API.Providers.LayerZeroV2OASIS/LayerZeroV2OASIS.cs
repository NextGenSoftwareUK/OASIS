...
namespace NextGenSoftware.OASIS.API.Providers.LayerZeroV2OASIS
{
    ...
    public class LayerZeroV2OASIS : OASISStorageProviderBase, IOASISStorageProvider, IOASISNETProvider, IOASISBlockchainStorageProvider
    {
        ...
        {
            var r = new OASISResult<bool>();
            try { _isActivated = false; _http.Dispose(); r.Result = true; r.Message = "LayerZeroV2OASIS deactivated"; }
            catch (Exception ex) { OASISErrorHandling.HandleError(ref r, $"LayerZeroV2OASIS deactivation failed: {ex.Message}", ex); }
            return r;
        }
        ...
        public override async Task<OASISResult<IAvatarDetail>> LoadAvatarDetailAsync(Guid id, int v = 0) { var r = new OASISResult<IAvatarDetail>(); OASISErrorHandling.HandleError(ref r, "LayerZeroV2OASIS does not support avatar detail storage"); return r; }
        public override async Task<OASISResult<IAvatarDetail>> SaveAvatarDetailAsync(IAvatarDetail ad) { var r = new OASISResult<IAvatarDetail>(); OASISErrorHandling.HandleError(ref r, "LayerZeroV2OASIS does not support avatar detail storage"); return r; }
