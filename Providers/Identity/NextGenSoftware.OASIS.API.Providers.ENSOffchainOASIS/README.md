...
ENS Offchain - Ethereum Name Service with offchain resolver support.
...
```json
{
  "DefaultProviders": ["ENSOffchainOASIS"]
}
```
...
- [NuGet](https://www.nuget.org/packages/NextGenSoftware.OASIS.API.Providers.ENSOffchainOASIS/)
