    ...
    <div className="glass-card gradient-ring relative overflow-hidden rounded-3xl border border-[var(--color-card-border)]/60">
      ...
      <div className="relative grid gap-6 p-6 lg:grid-cols-[280px_1fr] lg:gap-10 lg:p-8">
        <aside className="space-y-6">
          <h2 className="text-lg font-semibold text-[var(--color-foreground)]">Music Tokenization Flow</h2>
          <p className="text-sm leading-relaxed text-[var(--muted)]">
            Configure your music catalog, set up automated royalty splits, and deploy smart contracts with micro-licensing capabilities.
          </p>
